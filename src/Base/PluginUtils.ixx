...
std::wstring GetPlayerNameFromEncodedString(const wchar_t *message,
                                            const wchar_t **start_pos_out = nullptr,
                                            const wchar_t **out_pos_out = nullptr);
...
public:
    ...
    {
        return decoding && decoded_ws.empty();
    };
...
const wchar_t *diacritics[] = {
    L"A\x0041\x0410\x24B6\xFF21\x00C0\x00C1\x00C2\x1EA6\x1EA4\x1EAA\x1EA8\x00C3\x0100\x0102\x1EB0\x1EAE\x1EB4\x1EB2"
    L"\x0226\x01E0\x00C4\x01DE\x1EA2\x00C5\x01FA\x01CD\x0200\x0202\x1EA0\x1EAC\x1EB6\x1E00\x0104\x023A\x2C6F",
    ...
    L"E\x0401\x0045\x24BA\xFF25\x00C8\x00C9\x00CA\x1EC0\x1EBE\x1EC4\x1EC2\x1EBC\x0112\x1E14\x1E16\x0114\x0116\x00CB"
    L"\x1EBA\x011A\x0204\x0206\x1EB8\x1EC6\x0228\x1E1C\x0118\x1E18\x1E1A\x0190\x018E",
    L"F\x0046\x24BB\xFF26\x1E1E\x0191\xA77B",
    L"G\u0047\u24BC\uFF27\u01F4\u011C\u1E20\u011E\u0120\u01E6\u0122\u01E4\u0193\uA7A0\uA77D\uA77E",
    L"H\u0048\u24BD\uFF28\u0124\u1E22\u1E26\u021E\u1E24\u1E28\u1E2A\u0126\u2C67\u2C75\uA78D",
    L"I\u0049\u24BE\uFF29\u00CC\u00CD\u00CE\u0128\u012A\u012C\u0130\u00CF\u1E2E\u1EC8\u01CF\u0208\u020A\u1ECA\u012E"
    L"\u1E2C\u0197",
    L"J\u004A\u24BF\uFF2A\u0134\u0248",
    L"K\u041A\u004B\u24C0\uFF2B\u1E30\u01E8\u1E32\u0136\u1E34\u0198\u2C69\uA740\uA742\uA744\uA7A2",
    ...
    L"M\u041C\u004D\u24C2\uFF2D\u1E3E\u1E40\u1E42\u2C6E\u019C",
    L"N\u004E\u24C3\uFF2E\u01F8\u0143\u00D1\u1E44\u0147\u1E46\u0145\u1E4A\u1E48\u0220\u019D\uA790\uA7A4",
    L"O\u004F\u24C4\uFF2F\u00D2\u00D3\u00D4\u1ED2\u1ED0\u1ED6\u1ED4\u00D5\u1E4C\u022C\u1E4E\u014C\u1E50\u1E52\u014E"
    L"\u022E\u0230\u00D6\u022A\u1ECE\u0150\u01D1\u020C\u020E\u01A0\u1EDC\u1EDA\u1EE0\u1EDE\u1EE2\u1ECC\u1ED8\u01EA"
    L"\u01EC\u00D8\u01FE\u0186\u019F\uA74A\uA74C",
    L"P\u0050\u24C5\uFF30\u1E54\u1E56\u01A4\u2C63\uA750\uA752\uA754",
    L"Q\u0051\u24C6\uFF31\uA756\uA758\u024A",
    ...
    L"Y\u0059\u24CE\uFF39\u1EF2\u00DD\u0176\u1EF8\u0232\u1E8E\u0178\u1EF6\u1EF4\u01B3\u024E\u1EFE",
    L"Z\u005A\u24CF\uFF3A\u0179\u1E90\u017B\u017D\u1E92\u1E94\u01B5\u0224\u2C7F\u2C6B\uA762",
    L"a\u0061\u24D0\uFF41\u1E9A\u00E0\u00E1\u00E2\u1EA7\u1EA5\u1EAB\u1EA9\u00E3\u0101\u0103\u1EB1\u1EAF\u1EB5\u1EB3"
    L"\u0227\u01E1\u00E4\u01DF\u1EA3\u00E5\u01FB\u01CE\u0201\u0203\u1EA1\u1EAD\u1EB7\u1E01\u0105\u2C65\u0250\u03b1",
    L"b\u0062\u24D1\uFF42\u1E03\u1E05\u1E07\u0180\u0183\u0253",
    L"c\u0063\u24D2\uFF43\u0107\u0109\u010B\u010D\u00E7\u1E09\u0188\u023C\uA73F\u2184",
    L"d\u0064\u24D3\uFF44\u1E0B\u010F\u1E0D\u1E11\u1E13\u1E0F\u0111\u018C\u0256\u0257\uA77A",
    L"e\u0065\u24D4\uFF45\u00E8\u00E9\u00EA\u1EC1\u1EBF\u1EC5\u1EC3\u1EBD\u0113\u1E15\u1E17\u0115\u0117\u00EB\u1EBB"
    L"\u011B\u0205\u0207\u1EB9\u1EC7\u0229\u1E1D\u0119\u1E19\u1E1B\u0247\u025B\u01DD",
    L"f\u0066\u24D5\uFF46\u1E1F\u0192\uA77C",
    L"g\u0067\u24D6\uFF47\u01F5\u011D\u1E21\u011F\u0121\u01E7\u0123\u01E5\u0260\uA7A1\u1D79\uA77F",
    L"h\u0068\u24D7\uFF48\u0125\u1E23\u1E27\u021F\u1E25\u1E29\u1E2B\u1E96\u0127\u2C68\u2C76\u0265",
    L"i\u0069\u24D8\uFF49\u00EC\u00ED\u00EE\u0129\u012B\u012D\u00EF\u1E2F\u1EC9\u01D0\u0209\u020B\u1ECB\u012F\u1E2D"
    L"\u0268\u0131",
    L"j\u006A\u24D9\uFF4A\u0135\u01F0\u0249",
    L"k\u006B\u24DA\uFF4B\u1E31\u01E9\u1E33\u0137\u1E35\u0199\u2C6A\uA741\uA743\uA745\uA7A3",
    L"l\u006C\u24DB\uFF4C\u0140\u013A\u013E\u1E37\u1E39\u013C\u1E3D\u1E3B\u017F\u0142\u019A\u026B\u2C61\uA749\uA781"
    L"\uA747",
    L"m\u006D\u24DC\uFF4D\u1E3F\u1E41\u1E43\u0271\u026F\u043C",
...
std::string ToLower(std::string s)
{
    std::ranges::transform(s, s.begin(), [](const char c) -> char { return static_cast<char>(tolower(c)); });
    return s;
}

std::wstring ToLower(std::wstring s)
{
    std::ranges::transform(s, s.begin(), [](const wchar_t c) -> wchar_t { return static_cast<wchar_t>(tolower(c)); });
    return s;
}
...
std::wstring GetPlayerNameFromEncodedString(const wchar_t *message,
                                            const wchar_t **start_pos_out,
                                            const wchar_t **out_pos_out)
{
...
size_t TimeToString(const time_t utc_timestamp, std::string &out)
{
    ...
    if (timeinfo->tm_yday != nowinfo->tm_yday || timeinfo->tm_year != nowinfo->tm_year)
    {
        ...
        written +=
            snprintf(&out[written], out.capacity() - written, "%s %02d", months[timeinfo->tm_mon], timeinfo->tm_mday);
    }
