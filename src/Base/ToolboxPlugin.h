...
public:
    ...
    [[nodiscard]] virtual const char *Icon() const
    {
        return nullptr;
    }
    ...
    [[nodiscard]] virtual bool *GetVisiblePtr()
    {
        return nullptr;
    }

    // if a hide/close entry for this plugin should be added to the main menu
    [[nodiscard]] virtual bool ShowInMainMenu() const
    {
        return false;
    }

    // do we want to draw while the world map is showing?
    [[nodiscard]] virtual bool ShowOnWorldMap() const
    {
        return false;
    }
    ...
    virtual bool DrawTabButton(bool, bool, bool)
    {
        return false;
    }
