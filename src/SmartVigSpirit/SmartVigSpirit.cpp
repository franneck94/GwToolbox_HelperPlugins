...
{
    static SmartVigSpirit instance;
    return &instance;
}

void SmartVigSpirit::SignalTerminate()
{
...
void SmartVigSpirit::Initialize(ImGuiContext *ctx, const ImGuiAllocFns fns, const HMODULE toolbox_dll)
{
    ToolboxUIPlugin::Initialize(ctx, fns, toolbox_dll);

    GW::Chat::WriteChat(GW::Chat::CHANNEL_GWCA1, L"Initialized", L"SmartVigSpirit");
}
...
bool SmartVigSpirit::HeroSmarterSkills_Main()
{
