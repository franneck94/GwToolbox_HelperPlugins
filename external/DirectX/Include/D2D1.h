...
interface D2D1_DECLARE_INTERFACE("a2296057-ea42-4099-983b-539fb6505426") ID2D1Bitmap : public ID2D1Resource
{
    ...
    (__in_opt CONST D2D1_POINT_2U *destPoint, __in ID2D1Bitmap *bitmap, __in_opt CONST D2D1_RECT_U *srcRect) PURE;
    ...
    STDMETHOD(CopyFromMemory)(__in_opt CONST D2D1_RECT_U *dstRect, __in CONST void *srcData, UINT32 pitch) PURE;
    ...
    : public ID2D1Resource
{
    ...
    (__out_ecount(gradientStopsCount) D2D1_GRADIENT_STOP *gradientStops, UINT gradientStopsCount) CONST PURE;
...
interface D2D1_DECLARE_INTERFACE("2cd906a8-12e2-11dc-9fed-001143a055f9") ID2D1Brush : public ID2D1Resource
{
    ...
    STDMETHOD_(void, GetTransform)(__out D2D1_MATRIX_3X2_F *transform) CONST PURE;
...
interface D2D1_DECLARE_INTERFACE("2cd906ab-12e2-11dc-9fed-001143a055f9") ID2D1LinearGradientBrush : public ID2D1Brush
{
    ...
    (__deref_out ID2D1GradientStopCollection **gradientStopCollection) CONST PURE;
...
interface D2D1_DECLARE_INTERFACE("2cd9069d-12e2-11dc-9fed-001143a055f9") ID2D1StrokeStyle : public ID2D1Resource
{
    ...
    //
    STDMETHOD_(void, GetDashes)(__out_ecount(dashesCount) FLOAT *dashes, UINT dashesCount) CONST PURE;
...
interface D2D1_DECLARE_INTERFACE("2cd906a1-12e2-11dc-9fed-001143a055f9") ID2D1Geometry : public ID2D1Resource
{
    ...
    //
    STDMETHOD(GetBounds)(__in_opt CONST D2D1_MATRIX_3X2_F *worldTransform, __out D2D1_RECT_F *bounds) CONST PURE;
    ...
    (__in ID2D1Geometry *inputGeometry,
     ...
     FLOAT flatteningTolerance,
     __out D2D1_GEOMETRY_RELATION *relation) CONST PURE;
    ...
    (__in_opt CONST D2D1_MATRIX_3X2_F *worldTransform, FLOAT flatteningTolerance, __out FLOAT *area) CONST PURE;
    ...
    (__in_opt CONST D2D1_MATRIX_3X2_F *worldTransform, FLOAT flatteningTolerance, __out FLOAT *length) CONST PURE;
    ...
    //
    HRESULT
    GetBounds(CONST D2D1_MATRIX_3X2_F &worldTransform, __out D2D1_RECT_F *bounds) CONST
    {
    ...
    HRESULT
    StrokeContainsPoint(D2D1_POINT_2F point,
                        FLOAT strokeWidth,
                        __in_opt ID2D1StrokeStyle *strokeStyle,
                        CONST D2D1_MATRIX_3X2_F &worldTransform,
                        FLOAT flatteningTolerance,
    ...
    StrokeContainsPoint(D2D1_POINT_2F point,
                        ...
                        __out BOOL *contains) CONST
    {
        return StrokeContainsPoint(point,
                                   strokeWidth,
                                   strokeStyle,
                                   worldTransform,
    ...
    //
    HRESULT
    FillContainsPoint(D2D1_POINT_2F point, __in_opt CONST D2D1_MATRIX_3X2_F *worldTransform, __out BOOL *contains) CONST
    {
        return FillContainsPoint(point, worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE, contains);
    }

    HRESULT
    FillContainsPoint(D2D1_POINT_2F point, CONST D2D1_MATRIX_3X2_F &worldTransform, __out BOOL *contains) CONST
    {
        return FillContainsPoint(point, &worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE, contains);
    }
    ...
    //
    HRESULT
    Tessellate(__in_opt CONST D2D1_MATRIX_3X2_F *worldTransform, __in ID2D1TessellationSink *tessellationSink) CONST
    {
    ...
    //
    HRESULT
    Tessellate(CONST D2D1_MATRIX_3X2_F &worldTransform, __in ID2D1TessellationSink *tessellationSink) CONST
    {
        return Tessellate(&worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE, tessellationSink);
    }
    ...
    CombineWithGeometry(__in ID2D1Geometry *inputGeometry,
                        ...
                        __in ID2D1SimplifiedGeometrySink *geometrySink) CONST
    {
        return CombineWithGeometry(inputGeometry,
                                   combineMode,
    ...
    //
    HRESULT
    Outline(__in_opt CONST D2D1_MATRIX_3X2_F *worldTransform, __in ID2D1SimplifiedGeometrySink *geometrySink) CONST
    {
    ...
    //
    HRESULT
    Outline(CONST D2D1_MATRIX_3X2_F &worldTransform, __in ID2D1SimplifiedGeometrySink *geometrySink) CONST
    {
        return Outline(&worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE, geometrySink);
    }
    ...
    //
    HRESULT
    ComputeArea(CONST D2D1_MATRIX_3X2_F &worldTransform, FLOAT flatteningTolerance, __out FLOAT *area) CONST
    {
    ...
    //
    HRESULT
    ComputeArea(__in_opt CONST D2D1_MATRIX_3X2_F *worldTransform, __out FLOAT *area) CONST
    {
    ...
    //
    HRESULT
    ComputeArea(CONST D2D1_MATRIX_3X2_F &worldTransform, __out FLOAT *area) CONST
    {
        return ComputeArea(&worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE, area);
    }
    ...
    //
    HRESULT
    ComputeLength(CONST D2D1_MATRIX_3X2_F &worldTransform, FLOAT flatteningTolerance, __out FLOAT *length) CONST
    {
    ...
    //
    HRESULT
    ComputeLength(__in_opt CONST D2D1_MATRIX_3X2_F *worldTransform, __out FLOAT *length) CONST
    {
    ...
    //
    HRESULT
    ComputeLength(CONST D2D1_MATRIX_3X2_F &worldTransform, __out FLOAT *length) CONST
    {
        return ComputeLength(&worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE, length);
    }
    ...
    ComputePointAtLength(FLOAT length,
                         ...
                         __out_opt D2D1_POINT_2F *unitTangentVector) CONST
    {
        return ComputePointAtLength(length,
                                    worldTransform,
                                    D2D1_DEFAULT_FLATTENING_TOLERANCE,
                                    point,
                                    unitTangentVector);
    ...
    : public ID2D1Geometry
{
    ...
    STDMETHOD_(void, GetRoundedRect)(__out D2D1_ROUNDED_RECT *roundedRect) CONST PURE;
...
interface D2D1_DECLARE_INTERFACE("2cd906a6-12e2-11dc-9fed-001143a055f9") ID2D1GeometryGroup : public ID2D1Geometry
{
    ...
    (__out_ecount(geometriesCount) ID2D1Geometry **geometries, UINT geometriesCount) CONST PURE;
...
interface D2D1_DECLARE_INTERFACE("2cd906bb-12e2-11dc-9fed-001143a055f9") ID2D1TransformedGeometry : public ID2D1Geometry
{
    ...
    STDMETHOD_(void, GetSourceGeometry)(__deref_out ID2D1Geometry **sourceGeometry) CONST PURE;
...
interface D2D1_DECLARE_INTERFACE("2cd9069e-12e2-11dc-9fed-001143a055f9") ID2D1SimplifiedGeometrySink : public IUnknown
{
    ...
    STDMETHOD_(void, AddLines)(__in_ecount(pointsCount) CONST D2D1_POINT_2F *points, UINT pointsCount) PURE;

    STDMETHOD_(void, AddBeziers)(__in_ecount(beziersCount) CONST D2D1_BEZIER_SEGMENT *beziers, UINT beziersCount) PURE;
    ...
    : public ID2D1SimplifiedGeometrySink
{
    ...
    STDMETHOD_(void, AddQuadraticBezier)(__in CONST D2D1_QUADRATIC_BEZIER_SEGMENT *bezier) PURE;

    STDMETHOD_(void, AddQuadraticBeziers)
    (__in_ecount(beziersCount) CONST D2D1_QUADRATIC_BEZIER_SEGMENT *beziers, UINT beziersCount) PURE;
...
interface D2D1_DECLARE_INTERFACE("2cd906c1-12e2-11dc-9fed-001143a055f9") ID2D1TessellationSink : public IUnknown
{
    ...
    (__in_ecount(trianglesCount) CONST D2D1_TRIANGLE *triangles, UINT trianglesCount) PURE;
...
interface D2D1_DECLARE_INTERFACE("28506e39-ebf6-46a1-bb47-fd85565ab957") ID2D1DrawingStateBlock : public ID2D1Resource
{
    ...
    //
    STDMETHOD_(void, GetDescription)(__out D2D1_DRAWING_STATE_DESCRIPTION *stateDescription) CONST PURE;


    //
    // Sets the state description of this state block resource.
    //
    STDMETHOD_(void, SetDescription)(__in CONST D2D1_DRAWING_STATE_DESCRIPTION *stateDescription) PURE;


    //
    // Sets the text rendering parameters of this state block resource.
    //
    STDMETHOD_(void, SetTextRenderingParams)(__in_opt IDWriteRenderingParams *textRenderingParams = NULL) PURE;
    ...
    // returned.
    //
    STDMETHOD_(void, GetTextRenderingParams)(__deref_out_opt IDWriteRenderingParams **textRenderingParams) CONST PURE;
...
interface D2D1_DECLARE_INTERFACE("2cd90694-12e2-11dc-9fed-001143a055f9") ID2D1RenderTarget : public ID2D1Resource
{
    ...
    STDMETHOD_(void, FillRectangle)(__in CONST D2D1_RECT_F *rect, __in ID2D1Brush *brush) PURE;
    ...
    STDMETHOD_(void, FillRoundedRectangle)(__in CONST D2D1_ROUNDED_RECT *roundedRect, __in ID2D1Brush *brush) PURE;
    ...
    STDMETHOD_(void, FillEllipse)(__in CONST D2D1_ELLIPSE *ellipse, __in ID2D1Brush *brush) PURE;
    ...
    //
    STDMETHOD_(void, FillMesh)(__in ID2D1Mesh *mesh, __in ID2D1Brush *brush) PURE;
    ...
    //
    STDMETHOD_(void, GetTags)(__out_opt D2D1_TAG *tag1 = NULL, __out_opt D2D1_TAG *tag2 = NULL) CONST PURE;
    ...
    //
    STDMETHOD_(void, PushLayer)(__in CONST D2D1_LAYER_PARAMETERS *layerParameters, __in ID2D1Layer *layer) PURE;
    ...
    STDMETHOD(Flush)(__out_opt D2D1_TAG *tag1 = NULL, __out_opt D2D1_TAG *tag2 = NULL) PURE;
    ...
    // IDrawingStatckBlock.
    //
    STDMETHOD_(void, SaveDrawingState)(__inout ID2D1DrawingStateBlock *drawingStateBlock) CONST PURE;


    //
    // Copies the state stored in the block interface.
    //
    STDMETHOD_(void, RestoreDrawingState)(__in ID2D1DrawingStateBlock *drawingStateBlock) PURE;
    ...
    //
    STDMETHOD_(void, PushAxisAlignedClip)(__in CONST D2D1_RECT_F *clipRect, D2D1_ANTIALIAS_MODE antialiasMode) PURE;
    ...
    //
    STDMETHOD(EndDraw)(__out_opt D2D1_TAG *tag1 = NULL, __out_opt D2D1_TAG *tag2 = NULL) PURE;
    ...
    // supported.
    //
    STDMETHOD_(BOOL, IsSupported)(__in CONST D2D1_RENDER_TARGET_PROPERTIES *renderTargetProperties) CONST PURE;
    ...
    HRESULT
    CreateBitmap(D2D1_SIZE_U size, CONST D2D1_BITMAP_PROPERTIES &bitmapProperties, __deref_out ID2D1Bitmap **bitmap)
    {
    ...
    //
    HRESULT
    CreateBitmapFromWicBitmap(__in IWICBitmapSource *wicBitmapSource, __deref_out ID2D1Bitmap **bitmap)
    {
    ...
    //
    HRESULT
    CreateBitmapBrush(__in ID2D1Bitmap *bitmap, __deref_out ID2D1BitmapBrush **bitmapBrush)
    {
    ...
    HRESULT
    CreateSolidColorBrush(CONST D2D1_COLOR_F &color, __deref_out ID2D1SolidColorBrush **solidColorBrush)
    {
    ...
    HRESULT
    CreateGradientStopCollection(__in_ecount(gradientStopsCount) CONST D2D1_GRADIENT_STOP *gradientStops,
                                 UINT gradientStopsCount,
                                 __deref_out ID2D1GradientStopCollection **gradientStopCollection)
    {
        return CreateGradientStopCollection(gradientStops,
                                            gradientStopsCount,
                                            D2D1_GAMMA_2_2,
    ...
    HRESULT
    CreateCompatibleRenderTarget(__deref_out ID2D1BitmapRenderTarget **bitmapRenderTarget)
    {
        return CreateCompatibleRenderTarget(NULL,
                                            NULL,
                                            NULL,
    ...
    HRESULT
    CreateCompatibleRenderTarget(D2D1_SIZE_F desiredSize, __deref_out ID2D1BitmapRenderTarget **bitmapRenderTarget)
    {
    ...
    void DrawRectangle(CONST D2D1_RECT_F &rect,
                       __in ID2D1Brush *brush,
                       FLOAT strokeWidth = 1.0f,
    ...
    void FillRoundedRectangle(CONST D2D1_ROUNDED_RECT &roundedRect, __in ID2D1Brush *brush)
    {
    ...
    void PushLayer(CONST D2D1_LAYER_PARAMETERS &layerParameters, __in ID2D1Layer *layer)
    {
...
interface D2D1_DECLARE_INTERFACE("06152247-6f50-465a-9245-118bfd3b6007") ID2D1Factory : public IUnknown
{
    ...
    (__in CONST D2D1_RECT_F *rectangle, __deref_out ID2D1RectangleGeometry **rectangleGeometry) PURE;
    ...
    (__in CONST D2D1_ELLIPSE *ellipse, __deref_out ID2D1EllipseGeometry **ellipseGeometry) PURE;
    ...
    //
    STDMETHOD(CreatePathGeometry)(__deref_out ID2D1PathGeometry **pathGeometry) PURE;
    ...
    HRESULT
    CreateRectangleGeometry(CONST D2D1_RECT_F &rectangle, __deref_out ID2D1RectangleGeometry **rectangleGeometry)
    {
    ...
    HRESULT
    CreateEllipseGeometry(CONST D2D1_ELLIPSE &ellipse, __deref_out ID2D1EllipseGeometry **ellipseGeometry)
    {
    ...
    HRESULT
    CreateDrawingStateBlock(CONST D2D1_DRAWING_STATE_DESCRIPTION &drawingStateDescription,
    ...
    HRESULT
    CreateDrawingStateBlock(__deref_out ID2D1DrawingStateBlock **drawingStateBlock)
    {
    ...
    HRESULT
    CreateHwndRenderTarget(CONST D2D1_RENDER_TARGET_PROPERTIES &renderTargetProperties,
...
typedef struct ID2D1ResourceVtbl
{
    ...
    STDMETHOD_(void, GetFactory)(ID2D1Resource *This, __deref_out ID2D1Factory **factory) PURE;
} ID2D1ResourceVtbl;
...
typedef struct ID2D1BitmapVtbl
{
    ...
    STDMETHOD_(void, GetDpi)(ID2D1Bitmap *This, __out FLOAT *dpiX, __out FLOAT *dpiY) PURE;
    ...
    (ID2D1Bitmap *This, __in_opt CONST D2D1_RECT_U *dstRect, __in CONST void *srcData, UINT32 pitch) PURE;
} ID2D1BitmapVtbl;
...
#define ID2D1Bitmap_GetFactory(This, factory) ((This)->lpVtbl->Base.GetFactory((ID2D1Resource *)This, factory))
...
typedef struct ID2D1BrushVtbl
{
    ...
    STDMETHOD_(void, SetTransform)(ID2D1Brush *This, __in CONST D2D1_MATRIX_3X2_F *transform) PURE;

    STDMETHOD_(FLOAT, GetOpacity)(ID2D1Brush *This) PURE;

    STDMETHOD_(void, GetTransform)(ID2D1Brush *This, __out D2D1_MATRIX_3X2_F *transform) PURE;
} ID2D1BrushVtbl;
...
typedef struct ID2D1BitmapBrushVtbl
{
    ...
    (ID2D1BitmapBrush *This, D2D1_BITMAP_INTERPOLATION_MODE interpolationMode) PURE;

    STDMETHOD_(void, SetBitmap)(ID2D1BitmapBrush *This, __in ID2D1Bitmap *bitmap) PURE;
    ...
    STDMETHOD_(void, GetBitmap)(ID2D1BitmapBrush *This, __deref_out ID2D1Bitmap **bitmap) PURE;
...
typedef struct ID2D1SolidColorBrushVtbl
{
    ...
    STDMETHOD_(void, SetColor)(ID2D1SolidColorBrush *This, __in CONST D2D1_COLOR_F *color) PURE;
...
typedef struct ID2D1LinearGradientBrushVtbl
{
    ...
    STDMETHOD_(void, GetGradientStopCollection)
    (ID2D1LinearGradientBrush *This, __deref_out ID2D1GradientStopCollection **gradientStopCollection) PURE;
...
typedef struct ID2D1RadialGradientBrushVtbl
{
    ...
    STDMETHOD_(void, GetGradientStopCollection)
    (ID2D1RadialGradientBrush *This, __deref_out ID2D1GradientStopCollection **gradientStopCollection) PURE;
...
typedef struct ID2D1StrokeStyleVtbl
{
    ...
    STDMETHOD_(void, GetDashes)(ID2D1StrokeStyle *This, __out_ecount(dashesCount) FLOAT *dashes, UINT dashesCount) PURE;
...
typedef struct ID2D1GeometryVtbl
{
    ...
    STDMETHOD(GetBounds)
    (ID2D1Geometry *This, __in_opt CONST D2D1_MATRIX_3X2_F *worldTransform, __out D2D1_RECT_F *bounds) PURE;
    ...
    (ID2D1Geometry *This,
     __in_opt CONST D2D1_MATRIX_3X2_F *worldTransform,
     FLOAT flatteningTolerance,
     __out FLOAT *area) PURE;

    STDMETHOD(ComputeLength)
    (ID2D1Geometry *This,
     __in_opt CONST D2D1_MATRIX_3X2_F *worldTransform,
     FLOAT flatteningTolerance,
     __out FLOAT *length) PURE;
...
#define ID2D1Geometry_StrokeContainsPoint(This,                                                                        \
                                          point,                                                                       \
                                          strokeWidth,                                                                 \
                                          strokeStyle,                                                                 \
                                          worldTransform,                                                              \
                                          flatteningTolerance,                                                         \
                                          contains)                                                                    \
    ((This)->lpVtbl->StrokeContainsPoint(This,                                                                         \
                                         point,                                                                        \
                                         strokeWidth,                                                                  \
                                         strokeStyle,                                                                  \
                                         worldTransform,                                                               \
...
#define ID2D1Geometry_CombineWithGeometry(This,                                                                        \
                                          inputGeometry,                                                               \
                                          combineMode,                                                                 \
                                          inputGeometryTransform,                                                      \
                                          flatteningTolerance,                                                         \
                                          geometrySink)                                                                \
    ((This)->lpVtbl->CombineWithGeometry(This,                                                                         \
                                         inputGeometry,                                                                \
                                         combineMode,                                                                  \
                                         inputGeometryTransform,                                                       \
                                         flatteningTolerance,                                                          \
...
#define ID2D1Geometry_ComputePointAtLength(This,                                                                       \
                                           length,                                                                     \
                                           worldTransform,                                                             \
                                           flatteningTolerance,                                                        \
                                           point,                                                                      \
...
typedef struct ID2D1RectangleGeometryVtbl
{
    ...
    STDMETHOD_(void, GetRect)(ID2D1RectangleGeometry *This, __out D2D1_RECT_F *rect) PURE;
...
#define ID2D1RectangleGeometry_GetWidenedBounds(This,                                                                  \
                                                strokeWidth,                                                           \
                                                strokeStyle,                                                           \
                                                worldTransform,                                                        \
                                                flatteningTolerance,                                                   \
                                                bounds)                                                                \
    ((This)->lpVtbl->Base.GetWidenedBounds((ID2D1Geometry *)This,                                                      \
                                           strokeWidth,                                                                \
                                           strokeStyle,                                                                \
                                           worldTransform,                                                             \
                                           flatteningTolerance,                                                        \
...
#define ID2D1RectangleGeometry_StrokeContainsPoint(This,                                                               \
                                                   point,                                                              \
                                                   strokeWidth,                                                        \
                                                   strokeStyle,                                                        \
                                                   worldTransform,                                                     \
                                                   flatteningTolerance,                                                \
                                                   contains)                                                           \
    ((This)->lpVtbl->Base.StrokeContainsPoint((ID2D1Geometry *)This,                                                   \
                                              point,                                                                   \
                                              strokeWidth,                                                             \
                                              strokeStyle,                                                             \
                                              worldTransform,                                                          \
...
#define ID2D1RectangleGeometry_FillContainsPoint(This, point, worldTransform, flatteningTolerance, contains)           \
    ((This)->lpVtbl->Base.FillContainsPoint((ID2D1Geometry *)This,                                                     \
                                            point,                                                                     \
                                            worldTransform,                                                            \
                                            flatteningTolerance,                                                       \
                                            contains))

#define ID2D1RectangleGeometry_CompareWithGeometry(This,                                                               \
                                                   inputGeometry,                                                      \
                                                   inputGeometryTransform,                                             \
                                                   flatteningTolerance,                                                \
                                                   relation)                                                           \
    ((This)->lpVtbl->Base.CompareWithGeometry((ID2D1Geometry *)This,                                                   \
                                              inputGeometry,                                                           \
                                              inputGeometryTransform,                                                  \
                                              flatteningTolerance,                                                     \
                                              relation))
...
#define ID2D1RectangleGeometry_CombineWithGeometry(This,                                                               \
                                                   inputGeometry,                                                      \
                                                   combineMode,                                                        \
                                                   inputGeometryTransform,                                             \
                                                   flatteningTolerance,                                                \
                                                   geometrySink)                                                       \
    ((This)->lpVtbl->Base.CombineWithGeometry((ID2D1Geometry *)This,                                                   \
                                              inputGeometry,                                                           \
                                              combineMode,                                                             \
                                              inputGeometryTransform,                                                  \
                                              flatteningTolerance,                                                     \
...
#define ID2D1RectangleGeometry_ComputePointAtLength(This,                                                              \
                                                    length,                                                            \
                                                    worldTransform,                                                    \
                                                    flatteningTolerance,                                               \
                                                    point,                                                             \
                                                    unitTangentVector)                                                 \
    ((This)->lpVtbl->Base.ComputePointAtLength((ID2D1Geometry *)This,                                                  \
                                               length,                                                                 \
                                               worldTransform,                                                         \
                                               flatteningTolerance,                                                    \
                                               point,                                                                  \
...
#define ID2D1RectangleGeometry_Widen(This,                                                                             \
                                     strokeWidth,                                                                      \
                                     strokeStyle,                                                                      \
                                     worldTransform,                                                                   \
                                     flatteningTolerance,                                                              \
                                     geometrySink)                                                                     \
    ((This)->lpVtbl->Base.Widen((ID2D1Geometry *)This,                                                                 \
                                strokeWidth,                                                                           \
                                strokeStyle,                                                                           \
                                worldTransform,                                                                        \
                                flatteningTolerance,                                                                   \
...
typedef struct ID2D1RoundedRectangleGeometryVtbl
{
    ...
    STDMETHOD_(void, GetRoundedRect)(ID2D1RoundedRectangleGeometry *This, __out D2D1_ROUNDED_RECT *roundedRect) PURE;
...
#define ID2D1RoundedRectangleGeometry_GetWidenedBounds(This,                                                           \
                                                       strokeWidth,                                                    \
                                                       strokeStyle,                                                    \
                                                       worldTransform,                                                 \
                                                       flatteningTolerance,                                            \
...
#define ID2D1RoundedRectangleGeometry_StrokeContainsPoint(This,                                                        \
                                                          point,                                                       \
                                                          strokeWidth,                                                 \
                                                          strokeStyle,                                                 \
                                                          worldTransform,                                              \
...
#define ID2D1RoundedRectangleGeometry_CompareWithGeometry(This,                                                        \
                                                          inputGeometry,                                               \
                                                          inputGeometryTransform,                                      \
                                                          flatteningTolerance,                                         \
                                                          relation)                                                    \
...
#define ID2D1RoundedRectangleGeometry_Simplify(This,                                                                   \
                                               simplificationOption,                                                   \
                                               worldTransform,                                                         \
                                               flatteningTolerance,                                                    \
                                               geometrySink)                                                           \
...
#define ID2D1RoundedRectangleGeometry_CombineWithGeometry(This,                                                        \
                                                          inputGeometry,                                               \
                                                          combineMode,                                                 \
                                                          inputGeometryTransform,                                      \
                                                          flatteningTolerance,                                         \
...
#define ID2D1RoundedRectangleGeometry_ComputePointAtLength(This,                                                       \
                                                           length,                                                     \
                                                           worldTransform,                                             \
                                                           flatteningTolerance,                                        \
                                                           point,                                                      \
...
#define ID2D1RoundedRectangleGeometry_Widen(This,                                                                      \
                                            strokeWidth,                                                               \
                                            strokeStyle,                                                               \
                                            worldTransform,                                                            \
                                            flatteningTolerance,                                                       \
...
typedef struct ID2D1EllipseGeometryVtbl
{
    ...
    STDMETHOD_(void, GetEllipse)(ID2D1EllipseGeometry *This, __out D2D1_ELLIPSE *ellipse) PURE;
...
#define ID2D1EllipseGeometry_GetWidenedBounds(This,                                                                    \
                                              strokeWidth,                                                             \
                                              strokeStyle,                                                             \
                                              worldTransform,                                                          \
                                              flatteningTolerance,                                                     \
...
#define ID2D1EllipseGeometry_StrokeContainsPoint(This,                                                                 \
                                                 point,                                                                \
                                                 strokeWidth,                                                          \
                                                 strokeStyle,                                                          \
                                                 worldTransform,                                                       \
...
#define ID2D1EllipseGeometry_CombineWithGeometry(This,                                                                 \
                                                 inputGeometry,                                                        \
                                                 combineMode,                                                          \
                                                 inputGeometryTransform,                                               \
                                                 flatteningTolerance,                                                  \
...
#define ID2D1EllipseGeometry_ComputePointAtLength(This,                                                                \
                                                  length,                                                              \
                                                  worldTransform,                                                      \
                                                  flatteningTolerance,                                                 \
                                                  point,                                                               \
...
typedef struct ID2D1GeometryGroupVtbl
{
    ...
    STDMETHOD_(void, GetSourceGeometries)
    (ID2D1GeometryGroup *This, __out_ecount(geometriesCount) ID2D1Geometry **geometries, UINT geometriesCount) PURE;
...
#define ID2D1GeometryGroup_GetWidenedBounds(This,                                                                      \
                                            strokeWidth,                                                               \
                                            strokeStyle,                                                               \
                                            worldTransform,                                                            \
                                            flatteningTolerance,                                                       \
...
#define ID2D1GeometryGroup_StrokeContainsPoint(This,                                                                   \
                                               point,                                                                  \
                                               strokeWidth,                                                            \
                                               strokeStyle,                                                            \
                                               worldTransform,                                                         \
...
#define ID2D1GeometryGroup_CompareWithGeometry(This,                                                                   \
                                               inputGeometry,                                                          \
                                               inputGeometryTransform,                                                 \
                                               flatteningTolerance,                                                    \
                                               relation)                                                               \
...
#define ID2D1GeometryGroup_CombineWithGeometry(This,                                                                   \
                                               inputGeometry,                                                          \
                                               combineMode,                                                            \
                                               inputGeometryTransform,                                                 \
                                               flatteningTolerance,                                                    \
...
#define ID2D1GeometryGroup_ComputePointAtLength(This,                                                                  \
                                                length,                                                                \
                                                worldTransform,                                                        \
                                                flatteningTolerance,                                                   \
                                                point,                                                                 \
...
typedef struct ID2D1TransformedGeometryVtbl
{
    ...
    (ID2D1TransformedGeometry *This, __deref_out ID2D1Geometry **sourceGeometry) PURE;

    STDMETHOD_(void, GetTransform)(ID2D1TransformedGeometry *This, __out D2D1_MATRIX_3X2_F *transform) PURE;
...
#define ID2D1TransformedGeometry_GetWidenedBounds(This,                                                                \
                                                  strokeWidth,                                                         \
                                                  strokeStyle,                                                         \
                                                  worldTransform,                                                      \
                                                  flatteningTolerance,                                                 \
...
#define ID2D1TransformedGeometry_StrokeContainsPoint(This,                                                             \
                                                     point,                                                            \
                                                     strokeWidth,                                                      \
                                                     strokeStyle,                                                      \
                                                     worldTransform,                                                   \
...
#define ID2D1TransformedGeometry_CompareWithGeometry(This,                                                             \
                                                     inputGeometry,                                                    \
                                                     inputGeometryTransform,                                           \
                                                     flatteningTolerance,                                              \
                                                     relation)                                                         \
...
#define ID2D1TransformedGeometry_Simplify(This,                                                                        \
                                          simplificationOption,                                                        \
                                          worldTransform,                                                              \
                                          flatteningTolerance,                                                         \
                                          geometrySink)                                                                \
...
#define ID2D1TransformedGeometry_CombineWithGeometry(This,                                                             \
                                                     inputGeometry,                                                    \
                                                     combineMode,                                                      \
                                                     inputGeometryTransform,                                           \
                                                     flatteningTolerance,                                              \
...
#define ID2D1TransformedGeometry_ComputePointAtLength(This,                                                            \
                                                      length,                                                          \
                                                      worldTransform,                                                  \
                                                      flatteningTolerance,                                             \
                                                      point,                                                           \
...
typedef struct ID2D1SimplifiedGeometrySinkVtbl
{
    ...
    (ID2D1SimplifiedGeometrySink *This, D2D1_POINT_2F startPoint, D2D1_FIGURE_BEGIN figureBegin) PURE;

    STDMETHOD_(void, AddLines)
    (ID2D1SimplifiedGeometrySink *This, __in_ecount(pointsCount) CONST D2D1_POINT_2F *points, UINT pointsCount) PURE;
...
typedef struct ID2D1GeometrySinkVtbl
{
    ...
    STDMETHOD_(void, AddBezier)(ID2D1GeometrySink *This, __in CONST D2D1_BEZIER_SEGMENT *bezier) PURE;

    STDMETHOD_(void, AddQuadraticBezier)
    (ID2D1GeometrySink *This, __in CONST D2D1_QUADRATIC_BEZIER_SEGMENT *bezier) PURE;
    ...
    STDMETHOD_(void, AddArc)(ID2D1GeometrySink *This, __in CONST D2D1_ARC_SEGMENT *arc) PURE;
...
typedef struct ID2D1TessellationSinkVtbl
{
    ...
    STDMETHOD_(void, AddTriangles)
    (ID2D1TessellationSink *This, __in_ecount(trianglesCount) CONST D2D1_TRIANGLE *triangles, UINT trianglesCount) PURE;
...
typedef struct ID2D1PathGeometryVtbl
{
    ...
    STDMETHOD(Open)(ID2D1PathGeometry *This, __deref_out ID2D1GeometrySink **geometrySink) PURE;

    STDMETHOD(Stream)(ID2D1PathGeometry *This, __in ID2D1GeometrySink *geometrySink) PURE;
...
#define ID2D1PathGeometry_GetWidenedBounds(This,                                                                       \
                                           strokeWidth,                                                                \
                                           strokeStyle,                                                                \
                                           worldTransform,                                                             \
                                           flatteningTolerance,                                                        \
...
#define ID2D1PathGeometry_StrokeContainsPoint(This,                                                                    \
                                              point,                                                                   \
                                              strokeWidth,                                                             \
                                              strokeStyle,                                                             \
                                              worldTransform,                                                          \
...
#define ID2D1PathGeometry_CompareWithGeometry(This,                                                                    \
                                              inputGeometry,                                                           \
                                              inputGeometryTransform,                                                  \
                                              flatteningTolerance,                                                     \
                                              relation)                                                                \
...
#define ID2D1PathGeometry_CombineWithGeometry(This,                                                                    \
                                              inputGeometry,                                                           \
                                              combineMode,                                                             \
                                              inputGeometryTransform,                                                  \
                                              flatteningTolerance,                                                     \
...
#define ID2D1PathGeometry_ComputePointAtLength(This,                                                                   \
                                               length,                                                                 \
                                               worldTransform,                                                         \
                                               flatteningTolerance,                                                    \
                                               point,                                                                  \
...
typedef struct ID2D1MeshVtbl
{
    ...
    STDMETHOD(Open)(ID2D1Mesh *This, __deref_out ID2D1TessellationSink **tessellationSink) PURE;
} ID2D1MeshVtbl;
...
typedef struct ID2D1DrawingStateBlockVtbl
{
    ...
    (ID2D1DrawingStateBlock *This, __out D2D1_DRAWING_STATE_DESCRIPTION *stateDescription) PURE;

    STDMETHOD_(void, SetDescription)
    (ID2D1DrawingStateBlock *This, __in CONST D2D1_DRAWING_STATE_DESCRIPTION *stateDescription) PURE;

    STDMETHOD_(void, SetTextRenderingParams)
    (ID2D1DrawingStateBlock *This, __in_opt IDWriteRenderingParams *textRenderingParams) PURE;

    STDMETHOD_(void, GetTextRenderingParams)
    (ID2D1DrawingStateBlock *This, __deref_out_opt IDWriteRenderingParams **textRenderingParams) PURE;
...
typedef struct ID2D1RenderTargetVtbl
{
    ...
    STDMETHOD(CreateLayer)
    (ID2D1RenderTarget *This, __in_opt CONST D2D1_SIZE_F *size, __deref_out ID2D1Layer **layer) PURE;

    STDMETHOD(CreateMesh)(ID2D1RenderTarget *This, __deref_out ID2D1Mesh **mesh) PURE;
    ...
    STDMETHOD_(void, FillRectangle)(ID2D1RenderTarget *This, __in CONST D2D1_RECT_F *rect, __in ID2D1Brush *brush) PURE;
    ...
    (ID2D1RenderTarget *This, __in CONST D2D1_ROUNDED_RECT *roundedRect, __in ID2D1Brush *brush) PURE;
    ...
    (ID2D1RenderTarget *This, __in CONST D2D1_ELLIPSE *ellipse, __in ID2D1Brush *brush) PURE;
    ...
    (ID2D1RenderTarget *This,
     __in ID2D1Geometry *geometry,
     __in ID2D1Brush *brush,
     __in_opt ID2D1Brush *opacityBrush) PURE;

    STDMETHOD_(void, FillMesh)(ID2D1RenderTarget *This, __in ID2D1Mesh *mesh, __in ID2D1Brush *brush) PURE;
    ...
    STDMETHOD_(void, SetTransform)(ID2D1RenderTarget *This, __in CONST D2D1_MATRIX_3X2_F *transform) PURE;

    STDMETHOD_(void, GetTransform)(ID2D1RenderTarget *This, __out D2D1_MATRIX_3X2_F *transform) PURE;
    ...
    STDMETHOD_(void, SetTextRenderingParams)
    (ID2D1RenderTarget *This, __in_opt IDWriteRenderingParams *textRenderingParams) PURE;

    STDMETHOD_(void, GetTextRenderingParams)
    (ID2D1RenderTarget *This, __deref_out_opt IDWriteRenderingParams **textRenderingParams) PURE;

    STDMETHOD_(void, SetTags)(ID2D1RenderTarget *This, D2D1_TAG tag1, D2D1_TAG tag2) PURE;

    STDMETHOD_(void, GetTags)(ID2D1RenderTarget *This, __out_opt D2D1_TAG *tag1, __out_opt D2D1_TAG *tag2) PURE;

    STDMETHOD_(void, PushLayer)
    (ID2D1RenderTarget *This, __in CONST D2D1_LAYER_PARAMETERS *layerParameters, __in ID2D1Layer *layer) PURE;

    STDMETHOD_(void, PopLayer)(ID2D1RenderTarget *This) PURE;

    STDMETHOD(Flush)(ID2D1RenderTarget *This, __out_opt D2D1_TAG *tag1, __out_opt D2D1_TAG *tag2) PURE;

    STDMETHOD_(void, SaveDrawingState)(ID2D1RenderTarget *This, __inout ID2D1DrawingStateBlock *drawingStateBlock) PURE;
    ...
    (ID2D1RenderTarget *This, __in CONST D2D1_RECT_F *clipRect, D2D1_ANTIALIAS_MODE antialiasMode) PURE;

    STDMETHOD_(void, PopAxisAlignedClip)(ID2D1RenderTarget *This) PURE;

    STDMETHOD_(void, Clear)(ID2D1RenderTarget *This, __in_opt CONST D2D1_COLOR_F *clearColor) PURE;

    STDMETHOD_(void, BeginDraw)(ID2D1RenderTarget *This) PURE;

    STDMETHOD(EndDraw)(ID2D1RenderTarget *This, __out_opt D2D1_TAG *tag1, __out_opt D2D1_TAG *tag2) PURE;
    ...
    STDMETHOD_(void, GetDpi)(ID2D1RenderTarget *This, __out FLOAT *dpiX, __out FLOAT *dpiY) PURE;
    ...
    (ID2D1RenderTarget *This, __in CONST D2D1_RENDER_TARGET_PROPERTIES *renderTargetProperties) PURE;
...
#define ID2D1RenderTarget_CreateGradientStopCollection(This,                                                           \
                                                       gradientStops,                                                  \
                                                       gradientStopsCount,                                             \
                                                       colorInterpolationGamma,                                        \
                                                       extendMode,                                                     \
                                                       gradientStopCollection)                                         \
    ((This)->lpVtbl->CreateGradientStopCollection(This,                                                                \
                                                  gradientStops,                                                       \
                                                  gradientStopsCount,                                                  \
                                                  colorInterpolationGamma,                                             \
                                                  extendMode,                                                          \
...
#define ID2D1RenderTarget_CreateLinearGradientBrush(This,                                                              \
                                                    linearGradientBrushProperties,                                     \
                                                    brushProperties,                                                   \
                                                    gradientStopCollection,                                            \
                                                    linearGradientBrush)                                               \
    ((This)->lpVtbl->CreateLinearGradientBrush(This,                                                                   \
                                               linearGradientBrushProperties,                                          \
                                               brushProperties,                                                        \
                                               gradientStopCollection,                                                 \
                                               linearGradientBrush))

#define ID2D1RenderTarget_CreateRadialGradientBrush(This,                                                              \
                                                    radialGradientBrushProperties,                                     \
                                                    brushProperties,                                                   \
                                                    gradientStopCollection,                                            \
                                                    radialGradientBrush)                                               \
    ((This)->lpVtbl->CreateRadialGradientBrush(This,                                                                   \
                                               radialGradientBrushProperties,                                          \
                                               brushProperties,                                                        \
                                               gradientStopCollection,                                                 \
                                               radialGradientBrush))

#define ID2D1RenderTarget_CreateCompatibleRenderTarget(This,                                                           \
                                                       desiredSize,                                                    \
                                                       desiredPixelSize,                                               \
                                                       desiredFormat,                                                  \
                                                       options,                                                        \
                                                       bitmapRenderTarget)                                             \
    ((This)->lpVtbl->CreateCompatibleRenderTarget(This,                                                                \
                                                  desiredSize,                                                         \
                                                  desiredPixelSize,                                                    \
                                                  desiredFormat,                                                       \
                                                  options,                                                             \
...
#define ID2D1RenderTarget_DrawText(This,                                                                               \
                                   string,                                                                             \
                                   stringLength,                                                                       \
                                   textFormat,                                                                         \
                                   layoutRect,                                                                         \
...
typedef struct ID2D1BitmapRenderTargetVtbl
{
    ...
    STDMETHOD(GetBitmap)(ID2D1BitmapRenderTarget *This, __deref_out ID2D1Bitmap **bitmap) PURE;
...
#define ID2D1BitmapRenderTarget_CreateGradientStopCollection(This,                                                     \
                                                             gradientStops,                                            \
                                                             gradientStopsCount,                                       \
                                                             colorInterpolationGamma,                                  \
                                                             extendMode,                                               \
...
#define ID2D1BitmapRenderTarget_CreateLinearGradientBrush(This,                                                        \
                                                          linearGradientBrushProperties,                               \
                                                          brushProperties,                                             \
                                                          gradientStopCollection,                                      \
                                                          linearGradientBrush)                                         \
...
#define ID2D1BitmapRenderTarget_CreateRadialGradientBrush(This,                                                        \
                                                          radialGradientBrushProperties,                               \
                                                          brushProperties,                                             \
                                                          gradientStopCollection,                                      \
                                                          radialGradientBrush)                                         \
...
#define ID2D1BitmapRenderTarget_CreateCompatibleRenderTarget(This,                                                     \
                                                             desiredSize,                                              \
                                                             desiredPixelSize,                                         \
                                                             desiredFormat,                                            \
                                                             options,                                                  \
...
#define ID2D1BitmapRenderTarget_FillOpacityMask(This,                                                                  \
                                                opacityMask,                                                           \
                                                brush,                                                                 \
                                                content,                                                               \
                                                destinationRectangle,                                                  \
                                                sourceRectangle)                                                       \
    ((This)->lpVtbl->Base.FillOpacityMask((ID2D1RenderTarget *)This,                                                   \
                                          opacityMask,                                                                 \
                                          brush,                                                                       \
                                          content,                                                                     \
                                          destinationRectangle,                                                        \
...
#define ID2D1BitmapRenderTarget_DrawBitmap(This,                                                                       \
                                           bitmap,                                                                     \
                                           destinationRectangle,                                                       \
                                           opacity,                                                                    \
                                           interpolationMode,                                                          \
                                           sourceRectangle)                                                            \
    ((This)->lpVtbl->Base.DrawBitmap((ID2D1RenderTarget *)This,                                                        \
                                     bitmap,                                                                           \
                                     destinationRectangle,                                                             \
                                     opacity,                                                                          \
                                     interpolationMode,                                                                \
...
#define ID2D1BitmapRenderTarget_DrawText(This,                                                                         \
                                         string,                                                                       \
                                         stringLength,                                                                 \
                                         textFormat,                                                                   \
                                         layoutRect,                                                                   \
                                         ...
                                         options,                                                                      \
                                         measuringMode)                                                                \
    ((This)->lpVtbl->Base.DrawText((ID2D1RenderTarget *)This,                                                          \
                                   string,                                                                             \
                                   stringLength,                                                                       \
                                   textFormat,                                                                         \
                                   layoutRect,                                                                         \
...
typedef struct ID2D1HwndRenderTargetVtbl
{
    ...
    STDMETHOD(Resize)(ID2D1HwndRenderTarget *This, __in CONST D2D1_SIZE_U *pixelSize) PURE;
...
#define ID2D1HwndRenderTarget_CreateGradientStopCollection(This,                                                       \
                                                           gradientStops,                                              \
                                                           gradientStopsCount,                                         \
                                                           colorInterpolationGamma,                                    \
                                                           extendMode,                                                 \
...
#define ID2D1HwndRenderTarget_CreateLinearGradientBrush(This,                                                          \
                                                        linearGradientBrushProperties,                                 \
                                                        brushProperties,                                               \
                                                        gradientStopCollection,                                        \
                                                        linearGradientBrush)                                           \
...
#define ID2D1HwndRenderTarget_CreateRadialGradientBrush(This,                                                          \
                                                        radialGradientBrushProperties,                                 \
                                                        brushProperties,                                               \
                                                        gradientStopCollection,                                        \
                                                        radialGradientBrush)                                           \
...
#define ID2D1HwndRenderTarget_CreateCompatibleRenderTarget(This,                                                       \
                                                           desiredSize,                                                \
                                                           desiredPixelSize,                                           \
                                                           desiredFormat,                                              \
                                                           options,                                                    \
...
#define ID2D1HwndRenderTarget_FillOpacityMask(This,                                                                    \
                                              opacityMask,                                                             \
                                              brush,                                                                   \
                                              content,                                                                 \
                                              destinationRectangle,                                                    \
...
#define ID2D1HwndRenderTarget_DrawBitmap(This,                                                                         \
                                         bitmap,                                                                       \
                                         destinationRectangle,                                                         \
                                         opacity,                                                                      \
                                         interpolationMode,                                                            \
...
#define ID2D1HwndRenderTarget_DrawText(This,                                                                           \
                                       string,                                                                         \
                                       stringLength,                                                                   \
                                       textFormat,                                                                     \
                                       layoutRect,                                                                     \
...
typedef struct ID2D1GdiInteropRenderTargetVtbl
{
    ...
    STDMETHOD(GetDC)(ID2D1GdiInteropRenderTarget *This, D2D1_DC_INITIALIZE_MODE mode, __out HDC *hdc) PURE;

    STDMETHOD(ReleaseDC)(ID2D1GdiInteropRenderTarget *This, __in_opt CONST RECT *update) PURE;
...
typedef struct ID2D1DCRenderTargetVtbl
{
    ...
    STDMETHOD(BindDC)(ID2D1DCRenderTarget *This, __in CONST HDC hDC, __in CONST RECT *pSubRect) PURE;
...
#define ID2D1DCRenderTarget_CreateGradientStopCollection(This,                                                         \
                                                         gradientStops,                                                \
                                                         gradientStopsCount,                                           \
                                                         colorInterpolationGamma,                                      \
                                                         extendMode,                                                   \
...
#define ID2D1DCRenderTarget_CreateLinearGradientBrush(This,                                                            \
                                                      linearGradientBrushProperties,                                   \
                                                      brushProperties,                                                 \
                                                      gradientStopCollection,                                          \
                                                      linearGradientBrush)                                             \
...
#define ID2D1DCRenderTarget_CreateRadialGradientBrush(This,                                                            \
                                                      radialGradientBrushProperties,                                   \
                                                      brushProperties,                                                 \
                                                      gradientStopCollection,                                          \
                                                      radialGradientBrush)                                             \
...
#define ID2D1DCRenderTarget_CreateCompatibleRenderTarget(This,                                                         \
                                                         desiredSize,                                                  \
                                                         desiredPixelSize,                                             \
                                                         desiredFormat,                                                \
                                                         options,                                                      \
...
#define ID2D1DCRenderTarget_DrawBitmap(This,                                                                           \
                                       bitmap,                                                                         \
                                       destinationRectangle,                                                           \
                                       opacity,                                                                        \
                                       interpolationMode,                                                              \
...
#define ID2D1DCRenderTarget_DrawText(This,                                                                             \
                                     string,                                                                           \
                                     stringLength,                                                                     \
                                     textFormat,                                                                       \
                                     layoutRect,                                                                       \
...
typedef struct ID2D1FactoryVtbl
{
    ...
    STDMETHOD_(void, GetDesktopDpi)(ID2D1Factory *This, __out FLOAT *dpiX, __out FLOAT *dpiY) PURE;
    ...
    STDMETHOD(CreateEllipseGeometry)
    (ID2D1Factory *This, __in CONST D2D1_ELLIPSE *ellipse, __deref_out ID2D1EllipseGeometry **ellipseGeometry) PURE;
    ...
    STDMETHOD(CreatePathGeometry)(ID2D1Factory *This, __deref_out ID2D1PathGeometry **pathGeometry) PURE;
...
#define ID2D1Factory_CreateHwndRenderTarget(This,                                                                      \
...
extern "C"
{
    ...
    //
    HRESULT WINAPI D2D1CreateFactory(__in D2D1_FACTORY_TYPE factoryType,
                                     __in REFIID riid,
                                     __in_opt CONST D2D1_FACTORY_OPTIONS *pFactoryOptions,
                                     __out void **ppIFactory);


    void WINAPI D2D1MakeRotateMatrix(__in FLOAT angle, __in D2D1_POINT_2F center, __out D2D1_MATRIX_3X2_F *matrix);

    void WINAPI D2D1MakeSkewMatrix(__in FLOAT angleX,
                                   __in FLOAT angleY,
...
inline HRESULT D2D1CreateFactory(__in D2D1_FACTORY_TYPE factoryType, __in REFIID riid, __out void **factory)
{
...
HRESULT D2D1CreateFactory(__in D2D1_FACTORY_TYPE factoryType, __out Factory **factory)
{
