...
XMFINLINE XMVECTOR XMQuaternionConjugate(FXMVECTOR Q)
{
    ...
    XMVECTOR Result = {-Q.vector4_f32[0], -Q.vector4_f32[1], -Q.vector4_f32[2], Q.vector4_f32[3]};
    return Result;
#elif defined(_XM_SSE_INTRINSICS_)
...
XMFINLINE XMVECTOR XMQuaternionLn(FXMVECTOR Q)
{
    ...
    static CONST XMVECTORF32 NegOneMinusEpsilon = {-(1.0f - 0.00001f),
                                                   -(1.0f - 0.00001f),
                                                   -(1.0f - 0.00001f),
                                                   -(1.0f - 0.00001f)};
    // Get W only
...
XMINLINE XMVECTOR XMQuaternionSlerpV(FXMVECTOR Q0, FXMVECTOR Q1, FXMVECTOR T)
{
    ...
    XMASSERT((T.vector4_f32[1] == T.vector4_f32[0]) && (T.vector4_f32[2] == T.vector4_f32[0]) &&
             (T.vector4_f32[3] == T.vector4_f32[0]));
    ...
    XMASSERT((XMVectorGetY(T) == XMVectorGetX(T)) && (XMVectorGetZ(T) == XMVectorGetX(T)) &&
...
XMINLINE VOID
XMQuaternionSquadSetup(XMVECTOR *pA, XMVECTOR *pB, XMVECTOR *pC, FXMVECTOR Q0, FXMVECTOR Q1, FXMVECTOR Q2, CXMVECTOR Q3)
{
...
XMFINLINE XMVECTOR XMQuaternionBaryCentricV(FXMVECTOR Q0, FXMVECTOR Q1, FXMVECTOR Q2, CXMVECTOR F, CXMVECTOR G)
{
    ...
    XMASSERT((XMVectorGetY(F) == XMVectorGetX(F)) && (XMVectorGetZ(F) == XMVectorGetX(F)) &&
             (XMVectorGetW(F) == XMVectorGetX(F)));
    XMASSERT((XMVectorGetY(G) == XMVectorGetX(G)) && (XMVectorGetZ(G) == XMVectorGetX(G)) &&
...
XMFINLINE XMVECTOR XMQuaternionRotationRollPitchYawFromVector(FXMVECTOR Angles // <Pitch, Yaw, Roll, 0>
)
{
#if defined(_XM_NO_INTRINSICS_)
...
{
#if defined(_XM_NO_INTRINSICS_)
    FLOAT fLengthSq = sqrtf((P.vector4_f32[0] * P.vector4_f32[0]) + (P.vector4_f32[1] * P.vector4_f32[1]) +
    ...
    {
        XMVECTOR vResult = {P.vector4_f32[0] * fLengthSq,
...
XMFINLINE XMVECTOR XMColorNegative(FXMVECTOR vColor)
{
    ...
    XMVECTOR vResult = {1.0f - vColor.vector4_f32[0],
...
XMFINLINE XMVECTOR XMColorAdjustSaturation(FXMVECTOR vColor, FLOAT fSaturation)
{
    ...
    FLOAT fLuminance = (vColor.vector4_f32[0] * gvLuminance.vector4_f32[0]) +
                       (vColor.vector4_f32[1] * gvLuminance.vector4_f32[1]) +
                       (vColor.vector4_f32[2] * gvLuminance.vector4_f32[2]);
    XMVECTOR vResult = {((vColor.vector4_f32[0] - fLuminance) * fSaturation) + fLuminance,
    ...
    vLuminance =
        _mm_shuffle_ps(vResult, vColor, _MM_SHUFFLE(3, 2, 2, 2)); // x = vResult.z,y = vResult.z,z = vColor.z,w=vColor.w
    vResult = _mm_shuffle_ps(vResult,
                             vLuminance,
