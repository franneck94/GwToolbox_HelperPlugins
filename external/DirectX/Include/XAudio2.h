...
DECLARE_INTERFACE_(IXAudio2, IUnknown)
{
    ...
    (THIS_ UINT32 Flags X2DEFAULT(0), XAUDIO2_PROCESSOR XAudio2Processor X2DEFAULT(XAUDIO2_DEFAULT_PROCESSOR)) PURE;
...
#define Declare_IXAudio2Voice_Methods()                                                                                \
    ...
    */                                                                       \
    ...
    (THIS_ UINT32 EffectIndex, __out_bcount(ParametersByteSize) void *pParameters, UINT32 ParametersByteSize) PURE;    \
                                                                                                                       \
    ...
    */                                                                       \
    ...
    (THIS_ __in const XAUDIO2_FILTER_PARAMETERS *pParameters, UINT32 OperationSet X2DEFAULT(XAUDIO2_COMMIT_NOW)) PURE; \
                                                                                                                       \
    ...
    */                                                                 \
    ...
    (THIS_ __in_opt IXAudio2Voice * pDestinationVoice, __out XAUDIO2_FILTER_PARAMETERS * pParameters) PURE;            \
                                                                                                                       \
    ...
    */                                                                         \
    ...
    (THIS_ UINT32 Channels,                                                                                            \
     __in_ecount(Channels) const float *pVolumes,                                                                      \
     UINT32 OperationSet X2DEFAULT(XAUDIO2_COMMIT_NOW)) PURE;                                                          \
                                                                                                                       \
...
#define IXAudio2_CreateSourceVoice(This,                                                                               \
                                   ...
                                   pSendList,                                                                          \
                                   pEffectChain)                                                                       \
    ((This)->lpVtbl->CreateSourceVoice(This,                                                                           \
                                       ppSourceVoice,                                                                  \
                                       pSourceFormat,                                                                  \
                                       Flags,                                                                          \
                                       MaxFrequencyRatio,                                                              \
...
#define IXAudio2_CreateSubmixVoice(This,                                                                               \
                                   ...
                                   pSendList,                                                                          \
                                   pEffectChain)                                                                       \
    ((This)->lpVtbl->CreateSubmixVoice(This,                                                                           \
                                       ppSubmixVoice,                                                                  \
                                       InputChannels,                                                                  \
                                       InputSampleRate,                                                                \
                                       Flags,                                                                          \
...
#define IXAudio2_CreateMasteringVoice(This,                                                                            \
                                      ...
                                      DeviceIndex,                                                                     \
                                      pEffectChain)                                                                    \
    ((This)->lpVtbl->CreateMasteringVoice(This,                                                                        \
                                          ppMasteringVoice,                                                            \
                                          InputChannels,                                                               \
                                          InputSampleRate,                                                             \
                                          Flags,                                                                       \
...
#define IXAudio2Voice_SetEffectParameters(This, EffectIndex, pParameters, ParametersByteSize, OperationSet)            \
    ((This)->lpVtbl->SetEffectParameters(This, EffectIndex, pParameters, ParametersByteSize, OperationSet))
#define IXAudio2Voice_GetEffectParameters(This, EffectIndex, pParameters, ParametersByteSize)                          \
...
#define IXAudio2Voice_SetOutputFilterParameters(This, pDestinationVoice, pParameters, OperationSet)                    \
    ((This)->lpVtbl->SetOutputFilterParameters(This, pDestinationVoice, pParameters, OperationSet))
#define IXAudio2Voice_GetOutputFilterParameters(This, pDestinationVoice, pParameters)                                  \
...
#define IXAudio2Voice_SetOutputMatrix(This,                                                                            \
                                      ...
                                      pLevelMatrix,                                                                    \
                                      OperationSet)                                                                    \
    ((This)->lpVtbl->SetOutputMatrix(This,                                                                             \
                                     pDestinationVoice,                                                                \
                                     SourceChannels,                                                                   \
                                     DestinationChannels,                                                              \
                                     pLevelMatrix,                                                                     \
                                     OperationSet))
#define IXAudio2Voice_GetOutputMatrix(This, pDestinationVoice, SourceChannels, DestinationChannels, pLevelMatrix)      \
