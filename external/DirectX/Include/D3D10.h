...
#define ID3D10Resource_GetEvictionPriority(This) ((This)->lpVtbl->GetEvictionPriority(This))
    ...
    struct CD3D10_BUFFER_DESC : public D3D10_BUFFER_DESC
    {
        ...
        explicit CD3D10_BUFFER_DESC(UINT byteWidth,
                                    UINT bindFlags,
...
#define ID3D10Buffer_GetDesc(This, pDesc) ((This)->lpVtbl->GetDesc(This, pDesc))
    ...
    struct CD3D10_TEXTURE1D_DESC : public D3D10_TEXTURE1D_DESC
    {
        ...
        explicit CD3D10_TEXTURE1D_DESC(DXGI_FORMAT format,
                                       UINT width,
                                       UINT arraySize = 1,
                                       UINT mipLevels = 0,
...
#define ID3D10Texture1D_GetDesc(This, pDesc) ((This)->lpVtbl->GetDesc(This, pDesc))
    ...
    struct CD3D10_TEXTURE2D_DESC : public D3D10_TEXTURE2D_DESC
    {
        ...
        explicit CD3D10_TEXTURE2D_DESC(DXGI_FORMAT format,
                                       UINT width,
                                       UINT height,
                                       UINT arraySize = 1,
                                       UINT mipLevels = 0,
...
#define ID3D10Texture2D_GetDesc(This, pDesc) ((This)->lpVtbl->GetDesc(This, pDesc))
    ...
    struct CD3D10_TEXTURE3D_DESC : public D3D10_TEXTURE3D_DESC
    {
        ...
        explicit CD3D10_TEXTURE3D_DESC(const D3D10_TEXTURE3D_DESC &o) : D3D10_TEXTURE3D_DESC(o)
        {
        }
        explicit CD3D10_TEXTURE3D_DESC(DXGI_FORMAT format,
                                       UINT width,
                                       UINT height,
                                       UINT depth,
                                       UINT mipLevels = 0,
        ...
        operator const D3D10_TEXTURE3D_DESC &() const
        {
            return *this;
        }
    };
...
#define D3D10_ENCODE_ANISOTROPIC_FILTER(bComparison)                                                                   \
    ((D3D10_FILTER)(D3D10_ANISOTROPIC_FILTERING_BIT | D3D10_ENCODE_BASIC_FILTER(D3D10_FILTER_TYPE_LINEAR,              \
                                                                                D3D10_FILTER_TYPE_LINEAR,              \
                                                                                D3D10_FILTER_TYPE_LINEAR,              \
                                                                                bComparison)))
#define D3D10_DECODE_MIN_FILTER(d3d10Filter)                                                                           \
    ((D3D10_FILTER_TYPE)(((d3d10Filter) >> D3D10_MIN_FILTER_SHIFT) & D3D10_FILTER_TYPE_MASK))
#define D3D10_DECODE_MAG_FILTER(d3d10Filter)                                                                           \
    ((D3D10_FILTER_TYPE)(((d3d10Filter) >> D3D10_MAG_FILTER_SHIFT) & D3D10_FILTER_TYPE_MASK))
#define D3D10_DECODE_MIP_FILTER(d3d10Filter)                                                                           \
    ((D3D10_FILTER_TYPE)(((d3d10Filter) >> D3D10_MIP_FILTER_SHIFT) & D3D10_FILTER_TYPE_MASK))
...
#define ID3D10Device_DrawIndexedInstanced(This,                                                                        \
...
#define ID3D10Device_DrawInstanced(This,                                                                               \
...
#define ID3D10Device_CopySubresourceRegion(This,                                                                       \
                                           pDstResource,                                                               \
                                           DstSubresource,                                                             \
                                           DstX,                                                                       \
                                           DstY,                                                                       \
...
#define ID3D10Device_UpdateSubresource(This,                                                                           \
                                       pDstResource,                                                                   \
                                       DstSubresource,                                                                 \
                                       pDstBox,                                                                        \
                                       pSrcData,                                                                       \
...
#define ID3D10Device_CreateInputLayout(This,                                                                           \
                                       pInputElementDescs,                                                             \
                                       NumElements,                                                                    \
...
#define ID3D10Device_CreateGeometryShaderWithStreamOutput(This,                                                        \
                                                          pShaderBytecode,                                             \
                                                          BytecodeLength,                                              \
                                                          pSODeclaration,                                              \
                                                          NumEntries,                                                  \
...
#define ID3D10Device_CheckCounter(This,                                                                                \
                                  pDesc,                                                                               \
                                  pType,                                                                               \
                                  pActiveCounters,                                                                     \
                                  szName,                                                                              \
