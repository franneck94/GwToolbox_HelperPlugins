...
#define DSCFXR_LOCSOFTWARE 0x00000020
    ...
    extern HRESULT WINAPI DirectSoundCaptureCreate(__in_opt LPCGUID pcGuidDevice,
                                                   __deref_out LPDIRECTSOUNDCAPTURE *ppDSC,
                                                   __null LPUNKNOWN pUnkOuter);
    extern HRESULT WINAPI DirectSoundCaptureEnumerateA(__in LPDSENUMCALLBACKA pDSEnumCallback,
                                                       __in_opt LPVOID pContext);
    extern HRESULT WINAPI DirectSoundCaptureEnumerateW(__in LPDSENUMCALLBACKW pDSEnumCallback,
                                                       __in_opt LPVOID pContext);
    ...
    extern HRESULT WINAPI DirectSoundCreate8(__in_opt LPCGUID pcGuidDevice,
                                             ...
                                             __null LPUNKNOWN pUnkOuter);
    extern HRESULT WINAPI DirectSoundCaptureCreate8(__in_opt LPCGUID pcGuidDevice,
                                                    __deref_out LPDIRECTSOUNDCAPTURE8 *ppDSC8,
                                                    __null LPUNKNOWN pUnkOuter);
    extern HRESULT WINAPI DirectSoundFullDuplexCreate(__in_opt LPCGUID pcGuidCaptureDevice,
...
#define INTERFACE IReferenceClock
    ...
    DECLARE_INTERFACE_(IReferenceClock, IUnknown)
    {
        ...
        (THIS_ REFERENCE_TIME rtBaseTime, REFERENCE_TIME rtStreamTime, HANDLE hEvent, __out LPDWORD pdwAdviseCookie)
            PURE;
...
#define INTERFACE IDirectSound
    ...
    DECLARE_INTERFACE_(IDirectSound, IUnknown)
    {
        ...
        (THIS_ __in LPDIRECTSOUNDBUFFER pDSBufferOriginal, __deref_out LPDIRECTSOUNDBUFFER * ppDSBufferDuplicate) PURE;
...
#define INTERFACE IDirectSound8
    ...
    DECLARE_INTERFACE_(IDirectSound8, IDirectSound)
    {
        ...
        // IDirectSound methods
        STDMETHOD(CreateSoundBuffer)
        (THIS_ __in LPCDSBUFFERDESC pcDSBufferDesc, __out LPDIRECTSOUNDBUFFER * ppDSBuffer, __null LPUNKNOWN pUnkOuter)
            PURE;
        STDMETHOD(GetCaps)(THIS_ __out LPDSCAPS pDSCaps) PURE;
        STDMETHOD(DuplicateSoundBuffer)
        (THIS_ __in LPDIRECTSOUNDBUFFER pDSBufferOriginal, __out LPDIRECTSOUNDBUFFER * ppDSBufferDuplicate) PURE;
        STDMETHOD(SetCooperativeLevel)(THIS_ HWND hwnd, DWORD dwLevel) PURE;
        STDMETHOD(Compact)(THIS) PURE;
        STDMETHOD(GetSpeakerConfig)(THIS_ __out LPDWORD pdwSpeakerConfig) PURE;
        STDMETHOD(SetSpeakerConfig)(THIS_ DWORD dwSpeakerConfig) PURE;
...
#define INTERFACE IDirectSoundBuffer
    ...
    DECLARE_INTERFACE_(IDirectSoundBuffer, IUnknown)
    {
        ...
        (THIS_ __out_opt LPDWORD pdwCurrentPlayCursor, __out_opt LPDWORD pdwCurrentWriteCursor) PURE;
        STDMETHOD(GetFormat)
        ...
        (THIS_ DWORD dwOffset,
         ...
         __out_opt LPDWORD pdwAudioBytes2,
         DWORD dwFlags) PURE;
        ...
        (THIS_ __in_bcount(dwAudioBytes1) LPVOID pvAudioPtr1,
         DWORD dwAudioBytes1,
         __in_bcount_opt(dwAudioBytes2) LPVOID pvAudioPtr2,
...
#define INTERFACE IDirectSoundBuffer8
    ...
    DECLARE_INTERFACE_(IDirectSoundBuffer8, IDirectSoundBuffer)
    {
        ...
        (THIS_ DWORD dwFlags, DWORD dwEffectsCount, __out_ecount(dwEffectsCount) LPDWORD pdwResultCodes) PURE;
        STDMETHOD(GetObjectInPath)
        (THIS_ __in REFGUID rguidObject, DWORD dwIndex, __in REFGUID rguidInterface, __deref_out LPVOID * ppObject)
            PURE;
    };
...
#define INTERFACE IDirectSoundCaptureBuffer
    ...
    DECLARE_INTERFACE_(IDirectSoundCaptureBuffer, IUnknown)
    {
        ...
        STDMETHOD(GetCurrentPosition)
        (THIS_ __out_opt LPDWORD pdwCapturePosition, __out_opt LPDWORD pdwReadPosition) PURE;
        STDMETHOD(GetFormat)
        (THIS_ __out_bcount_opt(dwSizeAllocated) LPWAVEFORMATEX pwfxFormat,
         DWORD dwSizeAllocated,
         __out_opt LPDWORD pdwSizeWritten) PURE;
        ...
        (THIS_ __in LPDIRECTSOUNDCAPTURE pDirectSoundCapture, __in LPCDSCBUFFERDESC pcDSCBufferDesc) PURE;
        STDMETHOD(Lock)
        (THIS_ DWORD dwOffset,
         DWORD dwBytes,
         __deref_out_bcount(*pdwAudioBytes1) LPVOID * ppvAudioPtr1,
...
#define INTERFACE IDirectSoundNotify
    ...
    DECLARE_INTERFACE_(IDirectSoundNotify, IUnknown)
    {
        ...
        (THIS_ DWORD dwPositionNotifies, __in_ecount(dwPositionNotifies) LPCDSBPOSITIONNOTIFY pcPositionNotifies) PURE;
    };
...
#define INTERFACE IKsPropertySet
    ...
    DECLARE_INTERFACE_(IKsPropertySet, IUnknown)
    {
        ...
        STDMETHOD(Get)
        (THIS_ __in REFGUID rguidPropSet,
         ULONG ulId,
         __in_bcount(ulInstanceLength) LPVOID pInstanceData,
         ULONG ulInstanceLength,
         __out_bcount(ulDataLength) LPVOID pPropertyData,
         ULONG ulDataLength,
        ...
        (THIS_ __in REFGUID rguidPropSet,
         ...
         __in_bcount(ulInstanceLength) LPVOID pInstanceData,
         ULONG ulInstanceLength,
         __in_bcount(ulDataLength) LPVOID pPropertyData,
...
#define INTERFACE IDirectSoundFullDuplex
    ...
    DECLARE_INTERFACE_(IDirectSoundFullDuplex, IUnknown)
    {
        ...
        STDMETHOD(Initialize)
        (THIS_ __in LPCGUID pCaptureGuid,
         __in LPCGUID pRenderGuid,
         __in LPCDSCBUFFERDESC lpDscBufferDesc,
         __in LPCDSBUFFERDESC lpDsBufferDesc,
         HWND hWnd,
         DWORD dwLevel,
