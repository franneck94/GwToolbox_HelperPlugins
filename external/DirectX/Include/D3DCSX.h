...
#define INTERFACE ID3DX11Scan
    ...
    DECLARE_INTERFACE_(ID3DX11Scan, IUnknown)
    {
        ...
        //=============================================================================
        STDMETHOD(Scan)
        (THIS_ D3DX11_SCAN_DATA_TYPE ElementType,
...
#define INTERFACE ID3DX11SegmentedScan
    ...
    //  ppScanContext       new scan context
    //=============================================================================
    HRESULT WINAPI D3DX11CreateSegmentedScan(__in ID3D11DeviceContext *pDeviceContext,
                                             UINT MaxElementScanSize,
...
#define INTERFACE ID3DX11FFT
    ...
    DECLARE_INTERFACE_(ID3DX11FFT, IUnknown)
    {
        ...
        (THIS_ __in const ID3D11UnorderedAccessView *pInputBuffer, __inout ID3D11UnorderedAccessView **ppOutputBuffer)
            PURE;
