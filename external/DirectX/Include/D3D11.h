...
struct CD3D11_RECT : public D3D11_RECT
{
    ...
    operator const D3D11_RECT &() const
    {
        return *this;
    }
};
...
struct CD3D11_BOX : public D3D11_BOX
{
    ...
    operator const D3D11_BOX &() const
    {
        return *this;
    }
};
...
struct CD3D11_DEPTH_STENCIL_DESC : public D3D11_DEPTH_STENCIL_DESC
{
    ...
    explicit CD3D11_DEPTH_STENCIL_DESC(CD3D11_DEFAULT)
    {
        ...
        const D3D11_DEPTH_STENCILOP_DESC defaultStencilOp = {D3D11_STENCIL_OP_KEEP,
...
struct CD3D11_RASTERIZER_DESC : public D3D11_RASTERIZER_DESC
{
    ...
    explicit CD3D11_RASTERIZER_DESC(D3D11_FILL_MODE fillMode,
                                    D3D11_CULL_MODE cullMode,
                                    BOOL frontCounterClockwise,
                                    INT depthBias,
                                    FLOAT depthBiasClamp,
    ...
    operator const D3D11_RASTERIZER_DESC &() const
    {
        return *this;
    }
};
...
struct CD3D11_BUFFER_DESC : public D3D11_BUFFER_DESC
{
    ...
    explicit CD3D11_BUFFER_DESC(UINT byteWidth,
                                UINT bindFlags,
    ...
    operator const D3D11_BUFFER_DESC &() const
    {
        return *this;
    }
};
...
struct CD3D11_TEXTURE1D_DESC : public D3D11_TEXTURE1D_DESC
{
    ...
    explicit CD3D11_TEXTURE1D_DESC(DXGI_FORMAT format,
                                   UINT width,
                                   UINT arraySize = 1,
                                   UINT mipLevels = 0,
...
struct CD3D11_TEXTURE2D_DESC : public D3D11_TEXTURE2D_DESC
{
    ...
    explicit CD3D11_TEXTURE2D_DESC(DXGI_FORMAT format,
                                   UINT width,
                                   UINT height,
                                   UINT arraySize = 1,
                                   UINT mipLevels = 0,
...
struct CD3D11_TEXTURE3D_DESC : public D3D11_TEXTURE3D_DESC
{
    ...
    explicit CD3D11_TEXTURE3D_DESC(DXGI_FORMAT format,
                                   UINT width,
                                   UINT height,
                                   UINT depth,
                                   UINT mipLevels = 0,
...
struct CD3D11_SHADER_RESOURCE_VIEW_DESC : public D3D11_SHADER_RESOURCE_VIEW_DESC
{
    ...
    explicit CD3D11_SHADER_RESOURCE_VIEW_DESC(D3D11_SRV_DIMENSION viewDimension,
    ...
    explicit CD3D11_SHADER_RESOURCE_VIEW_DESC(__in ID3D11Texture1D *pTex1D,
                                              D3D11_SRV_DIMENSION viewDimension,
                                              DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN,
    ...
    explicit CD3D11_SHADER_RESOURCE_VIEW_DESC(__in ID3D11Texture2D *pTex2D,
                                              D3D11_SRV_DIMENSION viewDimension,
                                              DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN,
                                              UINT mostDetailedMip = 0,
                                              UINT mipLevels = -1,
                                              ...
                                              UINT arraySize = -1)      // NumCubes for TEXTURECUBEARRAY
    {
        ...
        if (DXGI_FORMAT_UNKNOWN == format ||
            ...
            (-1 == arraySize && (D3D11_SRV_DIMENSION_TEXTURE2DARRAY == viewDimension ||
                                 D3D11_SRV_DIMENSION_TEXTURE2DMSARRAY == viewDimension ||
    ...
    explicit CD3D11_SHADER_RESOURCE_VIEW_DESC(__in ID3D11Texture3D *pTex3D,
                                              DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN,
                                              UINT mostDetailedMip = 0,
                                              UINT mipLevels = -1)
    {
...
struct CD3D11_RENDER_TARGET_VIEW_DESC : public D3D11_RENDER_TARGET_VIEW_DESC
{
    ...
    explicit CD3D11_RENDER_TARGET_VIEW_DESC(__in ID3D11Texture1D *pTex1D,
                                            D3D11_RTV_DIMENSION viewDimension,
                                            DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN,
                                            UINT mipSlice = 0,
                                            UINT firstArraySlice = 0,
    ...
    explicit CD3D11_RENDER_TARGET_VIEW_DESC(__in ID3D11Texture2D *pTex2D,
                                            D3D11_RTV_DIMENSION viewDimension,
                                            DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN,
                                            UINT mipSlice = 0,
                                            UINT firstArraySlice = 0,
                                            UINT arraySize = -1)
    {
        ViewDimension = viewDimension;
        if (DXGI_FORMAT_UNKNOWN == format ||
            (-1 == arraySize && (D3D11_RTV_DIMENSION_TEXTURE2DARRAY == viewDimension ||
    ...
    explicit CD3D11_RENDER_TARGET_VIEW_DESC(__in ID3D11Texture3D *pTex3D,
                                            DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN,
                                            UINT mipSlice = 0,
                                            UINT firstWSlice = 0,
                                            UINT wSize = -1)
...
struct CD3D11_VIEWPORT : public D3D11_VIEWPORT
{
    ...
    explicit CD3D11_VIEWPORT(FLOAT topLeftX,
                             FLOAT topLeftY,
                             FLOAT width,
                             FLOAT height,
    ...
    operator const D3D11_VIEWPORT &() const
    {
        return *this;
    }
};
...
struct CD3D11_DEPTH_STENCIL_VIEW_DESC : public D3D11_DEPTH_STENCIL_VIEW_DESC
{
    ...
    explicit CD3D11_DEPTH_STENCIL_VIEW_DESC(D3D11_DSV_DIMENSION viewDimension,
                                            DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN,
                                            UINT mipSlice = 0,
                                            UINT firstArraySlice = 0,
                                            UINT arraySize = -1,
    ...
    explicit CD3D11_DEPTH_STENCIL_VIEW_DESC(__in ID3D11Texture1D *pTex1D,
                                            D3D11_DSV_DIMENSION viewDimension,
                                            DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN,
                                            UINT mipSlice = 0,
                                            UINT firstArraySlice = 0,
    ...
    explicit CD3D11_DEPTH_STENCIL_VIEW_DESC(__in ID3D11Texture2D *pTex2D,
                                            D3D11_DSV_DIMENSION viewDimension,
                                            DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN,
                                            UINT mipSlice = 0,
                                            UINT firstArraySlice = 0,
                                            ...
                                            UINT flags = 0)
    {
        ...
        Flags = flags;
        if (DXGI_FORMAT_UNKNOWN == format ||
            (-1 == arraySize && (D3D11_DSV_DIMENSION_TEXTURE2DARRAY == viewDimension ||
...
struct CD3D11_UNORDERED_ACCESS_VIEW_DESC : public D3D11_UNORDERED_ACCESS_VIEW_DESC
{
    ...
    explicit CD3D11_UNORDERED_ACCESS_VIEW_DESC(__in ID3D11Texture1D *pTex1D,
                                               D3D11_UAV_DIMENSION viewDimension,
                                               DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN,
                                               UINT mipSlice = 0,
                                               UINT firstArraySlice = 0,
    ...
    explicit CD3D11_UNORDERED_ACCESS_VIEW_DESC(__in ID3D11Texture2D *pTex2D,
                                               D3D11_UAV_DIMENSION viewDimension,
                                               DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN,
                                               UINT mipSlice = 0,
                                               UINT firstArraySlice = 0,
    ...
    explicit CD3D11_UNORDERED_ACCESS_VIEW_DESC(__in ID3D11Texture3D *pTex3D,
                                               DXGI_FORMAT format = DXGI_FORMAT_UNKNOWN,
                                               UINT mipSlice = 0,
                                               UINT firstWSlice = 0,
                                               UINT wSize = -1)
...
#define D3D11_ENCODE_ANISOTROPIC_FILTER(bComparison)                                                                   \
    ((D3D11_FILTER)(D3D11_ANISOTROPIC_FILTERING_BIT | D3D11_ENCODE_BASIC_FILTER(D3D11_FILTER_TYPE_LINEAR,              \
...
struct CD3D11_COUNTER_DESC : public D3D11_COUNTER_DESC
{
    ...
    operator const D3D11_COUNTER_DESC &() const
    {
        return *this;
    }
};
...
#define ID3D11ClassLinkage_CreateClassInstance(This,                                                                   \
                                               pClassTypeName,                                                         \
                                               ...
                                               SamplerOffset,                                                          \
                                               ppInstance)                                                             \
    ((This)->lpVtbl->CreateClassInstance(This,                                                                         \
                                         pClassTypeName,                                                               \
                                         ConstantBufferOffset,                                                         \
                                         ConstantVectorOffset,                                                         \
                                         TextureOffset,                                                                \
...
#define ID3D11DeviceContext_DrawIndexedInstanced(This,                                                                 \
...
#define ID3D11DeviceContext_DrawInstanced(This,                                                                        \
...
#define ID3D11DeviceContext_OMSetRenderTargetsAndUnorderedAccessViews(This,                                            \
                                                                      NumRTVs,                                         \
                                                                      ppRenderTargetViews,                             \
                                                                      pDepthStencilView,                               \
                                                                      UAVStartSlot,                                    \
                                                                      ...
                                                                      pUAVInitialCounts)                               \
    ((This)->lpVtbl->OMSetRenderTargetsAndUnorderedAccessViews(This,                                                   \
                                                               NumRTVs,                                                \
                                                               ppRenderTargetViews,                                    \
                                                               pDepthStencilView,                                      \
                                                               UAVStartSlot,                                           \
...
#define ID3D11DeviceContext_CopySubresourceRegion(This,                                                                \
                                                  pDstResource,                                                        \
                                                  DstSubresource,                                                      \
                                                  DstX,                                                                \
                                                  DstY,                                                                \
...
#define ID3D11DeviceContext_UpdateSubresource(This,                                                                    \
                                              pDstResource,                                                            \
                                              DstSubresource,                                                          \
                                              pDstBox,                                                                 \
                                              pSrcData,                                                                \
...
#define ID3D11DeviceContext_ResolveSubresource(This,                                                                   \
                                               pDstResource,                                                           \
                                               DstSubresource,                                                         \
                                               pSrcResource,                                                           \
                                               SrcSubresource,                                                         \
...
#define ID3D11DeviceContext_CSSetUnorderedAccessViews(This,                                                            \
                                                      StartSlot,                                                       \
                                                      NumUAVs,                                                         \
                                                      ppUnorderedAccessViews,                                          \
                                                      pUAVInitialCounts)                                               \
...
#define ID3D11DeviceContext_OMGetRenderTargetsAndUnorderedAccessViews(This,                                            \
                                                                      NumRTVs,                                         \
                                                                      ppRenderTargetViews,                             \
                                                                      ppDepthStencilView,                              \
                                                                      UAVStartSlot,                                    \
                                                                      NumUAVs,                                         \
                                                                      ppUnorderedAccessViews)                          \
    ((This)->lpVtbl->OMGetRenderTargetsAndUnorderedAccessViews(This,                                                   \
                                                               NumRTVs,                                                \
                                                               ppRenderTargetViews,                                    \
                                                               ppDepthStencilView,                                     \
                                                               UAVStartSlot,                                           \
...
#define ID3D11Device_CreateInputLayout(This,                                                                           \
                                       pInputElementDescs,                                                             \
                                       NumElements,                                                                    \
...
#define ID3D11Device_CreateGeometryShaderWithStreamOutput(This,                                                        \
                                                          pShaderBytecode,                                             \
                                                          BytecodeLength,                                              \
                                                          pSODeclaration,                                              \
                                                          NumEntries,                                                  \
...
#define ID3D11Device_CheckCounter(This,                                                                                \
                                  pDesc,                                                                               \
                                  pType,                                                                               \
                                  pActiveCounters,                                                                     \
                                  szName,                                                                              \
...
#include "d3d10shader.h"
    ...
    typedef HRESULT(WINAPI *PFN_D3D11_CREATE_DEVICE)(__in_opt IDXGIAdapter *,
                                                     ...
                                                     UINT FeatureLevels,
                                                     UINT,
                                                     __out_opt ID3D11Device **,
                                                     __out_opt D3D_FEATURE_LEVEL *,
                                                     __out_opt ID3D11DeviceContext **);

    HRESULT WINAPI D3D11CreateDevice(__in_opt IDXGIAdapter *pAdapter,
    ...
    typedef HRESULT(WINAPI *PFN_D3D11_CREATE_DEVICE_AND_SWAP_CHAIN)(__in_opt IDXGIAdapter *,
                                                                    ...
                                                                    UINT FeatureLevels,
                                                                    UINT,
                                                                    __in_opt CONST DXGI_SWAP_CHAIN_DESC *,
                                                                    __out_opt IDXGISwapChain **,
                                                                    __out_opt ID3D11Device **,
                                                                    __out_opt D3D_FEATURE_LEVEL *,
                                                                    __out_opt ID3D11DeviceContext **);

    HRESULT WINAPI D3D11CreateDeviceAndSwapChain(__in_opt IDXGIAdapter *pAdapter,
                                                 D3D_DRIVER_TYPE DriverType,
                                                 HMODULE Software,
                                                 UINT Flags,
                                                 __in_ecount_opt(FeatureLevels) CONST D3D_FEATURE_LEVEL *pFeatureLevels,
