...
#define D3DCOMPILE_EFFECT_ALLOW_SLOW_OPS (1 << 1)
    ...
    typedef HRESULT(WINAPI *pD3DCompile)(LPCVOID pSrcData,
                                         SIZE_T SrcDataSize,
                                         LPCSTR pFileName,
    ...
    typedef HRESULT(WINAPI *pD3DPreprocess)(LPCVOID pSrcData,
                                            SIZE_T SrcDataSize,
                                            LPCSTR pFileName,
                                            CONST D3D_SHADER_MACRO *pDefines,
                                            ID3DInclude *pInclude,
...
#define D3D_DISASM_DISABLE_DEBUG_INFO 0x00000010
    ...
    typedef HRESULT(WINAPI *pD3DDisassemble)(__in_bcount(SrcDataSize) LPCVOID pSrcData,
                                             __in SIZE_T SrcDataSize,
                                             __in UINT Flags,
                                             __in_opt LPCSTR szComments,
                                             __out ID3DBlob **ppDisassembly);
    ...
    HRESULT WINAPI D3DGetInputSignatureBlob(__in_bcount(SrcDataSize) LPCVOID pSrcData,
                                            __in SIZE_T SrcDataSize,
    ...
    HRESULT WINAPI D3DGetOutputSignatureBlob(__in_bcount(SrcDataSize) LPCVOID pSrcData,
                                             __in SIZE_T SrcDataSize,
                                             __out ID3DBlob **ppSignatureBlob);
    ...
    HRESULT WINAPI D3DGetInputAndOutputSignatureBlob(__in_bcount(SrcDataSize) LPCVOID pSrcData,
                                                     __in SIZE_T SrcDataSize,
                                                     __out ID3DBlob **ppSignatureBlob);
    ...
    HRESULT WINAPI D3DStripShader(__in_bcount(BytecodeLength) LPCVOID pShaderBytecode,
...
#define D3D_COMPRESS_SHADER_KEEP_ALL_PARTS 0x00000001
    ...
    HRESULT WINAPI D3DDecompressShaders(__in_bcount(SrcDataSize) LPCVOID pSrcData,
                                        __in SIZE_T SrcDataSize,
