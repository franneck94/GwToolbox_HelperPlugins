...
DECLARE_INTERFACE(ID3DXSaveUserData)
{
    ...
    (CONST D3DXFRAME * pFrame, LPD3DXFILESAVEOBJECT pXofSave, LPD3DXFILESAVEDATA pXofFrameData) PURE;

    STDMETHOD(AddMeshChildData)
    (CONST D3DXMESHCONTAINER * pMeshContainer, LPD3DXFILESAVEOBJECT pXofSave, LPD3DXFILESAVEDATA pXofMeshData) PURE;
...
DECLARE_INTERFACE_(ID3DXAnimationSet, IUnknown)
{
    ...
    // SRT
    STDMETHOD(GetSRT)
    (THIS_ DOUBLE PeriodicPosition,    // Position mapped to period (use GetPeriodicPosition)
...
DECLARE_INTERFACE_(ID3DXKeyframedAnimationSet, ID3DXAnimationSet)
{
    ...
    // Compression
    STDMETHOD(Compress)
    (THIS_ DWORD Flags,                     // Compression flags (use D3DXCOMPRESS_STRONG for better results)
...
DECLARE_INTERFACE_(ID3DXAnimationController, IUnknown)
{
    ...
    (THIS_ UINT Track, FLOAT NewSpeed, DOUBLE StartTime, DOUBLE Duration, D3DXTRANSITION_TYPE Transition) PURE;
    STDMETHOD_(D3DXEVENTHANDLE, KeyTrackWeight)
    (THIS_ UINT Track, FLOAT NewWeight, DOUBLE StartTime, DOUBLE Duration, D3DXTRANSITION_TYPE Transition) PURE;
    ...
    (THIS_ FLOAT NewBlendWeight, DOUBLE StartTime, DOUBLE Duration, D3DXTRANSITION_TYPE Transition) PURE;
    ...
    (THIS_ UINT MaxNumAnimationOutputs,
