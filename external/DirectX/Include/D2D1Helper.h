...
D2D1FORCEINLINE
D2D1_ARC_SEGMENT
ArcSegment(__in CONST D2D1_POINT_2F &point,
...
D2D1FORCEINLINE
D2D1_BEZIER_SEGMENT
BezierSegment(__in CONST D2D1_POINT_2F &point1, __in CONST D2D1_POINT_2F &point2, __in CONST D2D1_POINT_2F &point3)
{
...
BrushProperties(__in FLOAT opacity = 1.0, __in CONST D2D1_MATRIX_3X2_F &transform = D2D1::IdentityMatrix())
{
...
QuadraticBezierSegment(__in CONST D2D1_POINT_2F &point1, __in CONST D2D1_POINT_2F &point2)
{
...
LinearGradientBrushProperties(__in CONST D2D1_POINT_2F &startPoint, __in CONST D2D1_POINT_2F &endPoint)
{
...
D2D1FORCEINLINE
D2D1_PIXEL_FORMAT
PixelFormat(__in DXGI_FORMAT dxgiFormat = DXGI_FORMAT_UNKNOWN, __in D2D1_ALPHA_MODE alphaMode = D2D1_ALPHA_MODE_UNKNOWN)
{
...
RenderTargetProperties(D2D1_RENDER_TARGET_TYPE type = D2D1_RENDER_TARGET_TYPE_DEFAULT,
...
HwndRenderTargetProperties(__in HWND hwnd,
