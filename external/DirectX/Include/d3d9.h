...
#define INTERFACE IDirect3D9
    ...
    DECLARE_INTERFACE_(IDirect3D9, IUnknown)
    {
        ...
        (THIS_ UINT Adapter, D3DDEVTYPE DevType, D3DFORMAT AdapterFormat, D3DFORMAT BackBufferFormat, BOOL bWindowed)
            PURE;
...
#define INTERFACE IDirect3DDevice9Video
    ...
    DECLARE_INTERFACE_(IDirect3DDevice9Video, IUnknown)
    {
        ...
        (THIS_ CONST GUID * pCryptoType,
         CONST GUID * pDecodeProfile,
         IDirect3DCryptoSession9 * *ppCryptoSession,
         HANDLE * pCryptoHandle) PURE;
    };
...
#define INTERFACE IDirect3DCryptoSession9
    ...
    DECLARE_INTERFACE_(IDirect3DCryptoSession9, IUnknown)
    {
        ...
        (THIS_ IDirect3DSurface9 * pSrcSurface,
