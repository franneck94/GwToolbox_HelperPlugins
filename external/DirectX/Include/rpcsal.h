...
#define __RPC__inout_ecount_full_opt_string(size)                                                                      \
    __RPC__inout_ecount_full_opt(size) __pre __nullterminated __post __nullterminated
...
#define __RPC__deref_inout_ecount_full_opt_string(size)                                                                \
    __RPC__deref_inout_ecount_full_opt(size) __pre __deref __nullterminated __post __deref __nullterminated
...
#define __RPC__deref_inout_xcount_full_opt_string(size)                                                                \
    __RPC__deref_inout_opt __pre __deref __nullterminated __post __deref __nullterminated
...
#define __RPC__deref_opt_inout_string                                                                                  \
    __RPC__deref_opt_inout __pre __deref __nullterminated __post __deref __nullterminated
...
#define __RPC__deref_opt_inout_ecount_full_string(size)                                                                \
    __RPC__deref_opt_inout_ecount_full(size) __pre __deref __nullterminated __post __deref __nullterminated
...
#define __RPC__deref_out_ecount_opt(size)                                                                              \
    __RPC__out_ecount(size) __post __deref __exceptthat __maybenull __pre __deref __null
#define __RPC__deref_out_ecount_part_opt(size, length)                                                                 \
    __RPC__deref_out_ecount_part(size, length) __post __deref __exceptthat __maybenull __pre __deref __null
...
#define __RPC__deref_out_ecount_full_opt_string(size)                                                                  \
    __RPC__deref_out_ecount_part_opt(size, size) __post __deref __nullterminated __pre __deref __null
...
#define __RPC__deref_opt_inout_opt_string                                                                              \
    __RPC__deref_opt_inout_opt __pre __deref __nullterminated __post __deref __nullterminated
...
#define __RPC__deref_opt_inout_ecount_full_opt_string(size)                                                            \
    __RPC__deref_opt_inout_ecount_full_opt(size) __pre __deref __nullterminated __post __deref __nullterminated
