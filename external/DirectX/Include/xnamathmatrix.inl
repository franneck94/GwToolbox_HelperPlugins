...
XMINLINE XMMATRIX XMMatrixRotationRollPitchYawFromVector(FXMVECTOR Angles // <Pitch, Yaw, Roll, undefined>
)
{
    XMVECTOR Q;
    XMMATRIX M;
...
XMFINLINE _XMMATRIX::_XMMATRIX(FXMVECTOR R0, FXMVECTOR R1, FXMVECTOR R2, CXMVECTOR R3)
{
    r[0] = R0;
    r[1] = R1;
    r[2] = R2;
...
XMFINLINE _XMMATRIX::_XMMATRIX(FLOAT m00,
                               FLOAT m01,
                               FLOAT m02,
                               FLOAT m03,
                               FLOAT m10,
...
XMFINLINE _XMMATRIX::_XMMATRIX(CONST FLOAT *pArray)
{
...
XMFINLINE _XMMATRIX &_XMMATRIX::operator=(CONST _XMMATRIX &M)
{
    r[0] = M.r[0];
    r[1] = M.r[1];
    r[2] = M.r[2];
...
XMFINLINE _XMMATRIX _XMMATRIX::operator*(CONST _XMMATRIX &M) CONST
{
...
XMFINLINE _XMFLOAT3X3::_XMFLOAT3X3(FLOAT m00,
                                   FLOAT m01,
                                   FLOAT m02,
                                   FLOAT m10,
                                   FLOAT m11,
...
XMFINLINE _XMFLOAT3X3::_XMFLOAT3X3(CONST FLOAT *pArray)
{
    UINT Row;
    UINT Column;
...
XMFINLINE _XMFLOAT3X3 &_XMFLOAT3X3::operator=(CONST _XMFLOAT3X3 &Float3x3)
{
    _11 = Float3x3._11;
    _12 = Float3x3._12;
    _13 = Float3x3._13;
...
XMFINLINE _XMFLOAT4X3::_XMFLOAT4X3(FLOAT m00,
                                   FLOAT m01,
                                   FLOAT m02,
                                   FLOAT m10,
                                   FLOAT m11,
...
XMFINLINE _XMFLOAT4X3::_XMFLOAT4X3(CONST FLOAT *pArray)
{
    UINT Row;
    UINT Column;
...
XMFINLINE _XMFLOAT4X3 &_XMFLOAT4X3::operator=(CONST _XMFLOAT4X3 &Float4x3)
{
...
XMFINLINE XMFLOAT4X3A &XMFLOAT4X3A::operator=(CONST XMFLOAT4X3A &Float4x3)
{
...
XMFINLINE _XMFLOAT4X4::_XMFLOAT4X4(FLOAT m00,
                                   FLOAT m01,
                                   FLOAT m02,
                                   FLOAT m03,
                                   FLOAT m10,
...
XMFINLINE _XMFLOAT4X4::_XMFLOAT4X4(CONST FLOAT *pArray)
{
    UINT Row;
    UINT Column;
...
XMFINLINE _XMFLOAT4X4 &_XMFLOAT4X4::operator=(CONST _XMFLOAT4X4 &Float4x4)
{
...
XMFINLINE XMFLOAT4X4A &XMFLOAT4X4A::operator=(CONST XMFLOAT4X4A &Float4x4)
{
